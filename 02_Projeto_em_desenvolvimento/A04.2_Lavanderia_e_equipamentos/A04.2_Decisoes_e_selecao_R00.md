...
> **Revisão histórica, substituída pela [R01](A04.2_Decisoes_e_selecao_R01.md).** Elias escolheu a geladeira IB6 e determinou que a lava e seca seja LG. Os candidatos, preços e medidas da Midea/IF44 abaixo não são a seleção vigente. O conteúdo foi preservado para rastreabilidade.
...
- Água quente em todas as torneiras desejadas. Elias confirmou que não precisa de banho e torneira quente funcionando juntos. Considerar um ponto de uso por vez na avaliação inicial.
...
## Aquecimento: atualização após resposta de Elias
...
Antes da última resposta, compararam-se E17 e E21 com a hipótese de um chuveiro mais uma torneira. Essa simultaneidade não é mais requisito do projeto. O manual declara 17 e 21 L/min para elevação de 20 °C. Mantida a potência útil como aproximação, Q(30 °C) = Q(20 °C) x 20/30: 11,3 e 14 L/min. Não são vazões medidas no apartamento nem substituem curvas do fabricante.
...
2. Considerar um ponto por vez, conforme confirmado, e obter projetos de gás/hidráulica e tensões. Não comprar aquecedor com base apenas no anúncio GN.
