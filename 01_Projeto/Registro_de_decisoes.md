...
**Plano de guarda aceito no mesmo dia:** Elias pediu salvar e publicar as três cadeiras na lateral livre, com a central mais para fora e nenhuma na cabeceira. Modelo usa envelope Lina 44 × 47 × 94 cm registrado no projeto, com detalhes simplificados. Em 150, centros longitudinais a 25/75/125 cm da ponta; inserções propostas de 38 cm nas extremidades e 29,5 cm no centro (coluna hipotética de 12 cm + folga de 2). Projeções externas 9/17,5 cm. Na abertura para 180, centros distribuídos em módulos de 60 cm; movimento ilustrativo. Banco de 180 e largura transversal de entrada de 85 preservados. Faixa nominal tampo–IB6 em 150: **75,25 cm**, contra **54,25 cm** da antiga cadeira na cabeceira, ganho de **21 cm nesse trecho**. Pés, sapata, tampo, ferragem e circulação corporal seguem a validar; 75,25 não é largura livre de toda a entrada.
...
## Quarto — guarda-roupa até o teto com maleiro, 21/09/2026

Elias determinou: “o guarda roupa deve ir até o teto para ter o maleiro”. Requisito incorporado à [imagem realista R03](../03_Referencias/Quarto_proposta_realista_R03.md), ainda pendente de aprovação. Substitui a folga superior da R02 e a altura de 240 cm como limite final. Manter implantação do armário não embutido e espelho na lateral de 60 cm voltada para entrada. Altura efetiva, maleiro, cotas internas e arremate ao teto a compatibilizar com medição; divisão de portas ilustrada não constitui aprovação de ferragens. Sem publicação.

## Quarto — correção do guarda-roupa e espelho, 21/09/2026

Elias esclareceu que o guarda-roupa **não é embutido** e o espelho fica **na lateral do móvel**. Planta 2D conferida: frentes voltadas para a passagem ao lado da cama; espelho na lateral de 60 cm voltada à entrada, perpendicular às portas. Armário termina próximo ao pé da cama, preservando acesso. Gerada [proposta realista R02](../03_Referencias/Quarto_proposta_realista_R02.md), com móvel independente e espelho sobre painel amadeirado. Correção de implantação confirmada; imagem R02 ainda aguarda aprovação. Demais escolhas preservadas, sem publicação.
...
## Quarto — verde-oliva suave aprovado, 20/09/2026

Elias respondeu “gosto” à proposta de roupa de cama off-white e bege com verde-oliva suave na manta e nas almofadas. Confirmada essa composição de cores para o quarto e sua próxima imagem. Substitui a pendência de tonalidade registrada anteriormente; não define produtos, tecidos ou códigos de cor exatos. Móveis neutros e sem azul preservados.

## Quarto — roupa de cama com toque de cor, 20/09/2026

Elias escolheu “um toque de cor” entre roupa de cama inteiramente neutra e base clara com cor pontual. Registrar base clara e acento de cor como direção aprovada; verde-oliva suave na manta e nas almofadas, mencionado como exemplo, permanece proposta para a imagem, não confirmação específica de tonalidade. Preservar móveis neutros e decisões anteriores do quarto.

## Quarto — arandelas discretas, 20/09/2026

À escolha entre arandelas brancas discretas e pretas, Elias respondeu “quero discretas”. Confirmada direção de arandelas brancas, compactas e de desenho simples, preservando duas unidades direcionáveis de leitura e comandos independentes. Modelos e dimensões pendentes. Ver [iluminação R00](Portas_e_quarto/Iluminacao_R00.md).

## Quarto — composição da iluminação aprovada, 20/09/2026

Elias respondeu “sim, iluminação de cabeceira, e todo o resto q vc disse eu quero”. Confirmados plafon branco discreto no teto com luz difusa 3000 K e intensidade regulável, LED indireto escondido na cabeceira e duas arandelas pequenas direcionáveis para leitura, uma de cada lado com comando independente. Preservar os apoios para celular/óculos e compatibilizar com o aéreo alto/raso. [Detalhamento R00](Portas_e_quarto/Iluminacao_R00.md). Modelos, acabamento das arandelas, fluxo/potência, alturas, pontos e compatibilidade com dimmer ainda pendentes; sem compra ou publicação.
...
## Sala — correção da imagem R02, 20/09/2026

Elias pediu recuperar as três fotos escolhidas de Fagner Martins e incluí-las na moldura; corrigiu a identificação do cômodo visto no corredor para escritório e permitiu representá-lo com porta fechada. Produzida [R02](../03_Referencias/Sala_proposta_realista_R02.md) com as fotos recuperadas, composição completa e porta fechada. Cópias web e links específicos preservados. Imagem ainda pendente de aprovação para se tornar referência do plano real; nenhuma publicação.

## Base da mesa — aparência aprovada, 20/09/2026

Elias respondeu “gosto, deixe assim documentado” à proposta de coluna redonda com apoio oval baixo. **Base da mesa aprovada — 20/09/2026:** Elias confirmou coluna central única redonda e apoio oval baixo, alongado no sentido do comprimento da mesa, em metal preto fosco, sob medida. Tampo Arenza 180 × 75 cm com cantos R15 preservado. Aparência definida; diâmetro da coluna, dimensões/espessura da chapa, estabilidade e espaço para pernas/cadeiras continuam a conferir antes da fabricação. Ver [seleção R01](Sala_e_jantar/Base_mesa_selecao_R01.md). Nenhuma compra ou publicação.

## Base da mesa — pesquisa para escolha, 20/09/2026

Elias pediu avançar na base. [Seleção R01](Sala_e_jantar/Base_mesa_selecao_R01.md) compara tulipas comerciais e fabricação sob medida. Recomendada para decisão coluna circular única, chapa baixa oval longitudinal e preto fosco. Não registrar recomendação como aceite. Nenhuma base pronta confirmou suporte ao tampo 180 × 75 junto ao acesso do banco; DecoCasa largura 59 deixa 3 cm até a frente do banco no eixo central. Dimensões da coluna, chapa, apoio superior e estabilidade exigem desenho do fabricante; não aprovar sapata fictícia 26 × 30 do modelo. Nenhum contato externo ou compra.
...
## Espelho da sala — moldura combinando com os móveis, 20/09/2026

Ao escolher entre moldura fina de madeira e espelho sem moldura, Elias respondeu “combinar com os moveis”. Confirmada moldura fina de madeira no tom do conjunto, com Arenza como referência. Material/padrão exato e espessura ainda a detalhar. A medida inicial de 70 × 120 cm continua referência de simulação, sem aprovação dimensional de compra. Mantido local na face externa da parede do banheiro voltada à sala/jantar, compatibilizando com a lixeira. Não altera o espelho do quarto.
...
## Cortina — recolhimento para o sofá aprovado, 20/09/2026

Elias confirmou: “ok, anota recolhimento para o sofa e seguimos”. A cortina da parede inteira terá recolhimento para o lado do sofá. Mantidas as escolhas de tecido e acabamento; volume, profundidade e encontros com sofá/painel continuam pendentes conforme [estudo de compatibilização](Sala_e_jantar/Cortina_compatibilizacao_R00.md). Não há aprovação de deslocamento dos móveis nem substituição por blackout de enrolar. Sentido de abertura encerrado como decisão; seguir às próximas escolhas.


## Cortina — compatibilização solicitada com os móveis, 20/09/2026

Elias pediu calcular o melhor sentido de abertura considerando proximidade dos móveis. Criado Sala_e_jantar/Cortina_compatibilizacao_R00.md. Modelo/P01: parede245 cm, janela gráfica139 cm e margens38 cm no lado TV/68 cm no sofá; sofá a0 cm da parede da janela, painel a2,5 cm e prateleiras a5 cm. Referência técnica Silent Gliss wave60 estima56,35 cm por pacote unilateral ou28,175 cm por lado na central, antes de extremidades/retornos. Recolher no lado do sofá é candidata preferida, condicionada ao pacote real e operação da janela; central continua alternativa.

Encontrado conflito não contemplado no 3D: duas camadas wave60 no ensaio ocupam reserva de28 cm em profundidade, mesmo fechadas. Mover sofá28 cm sobrepõe18 cm ao banco; deslocar painel preservando115 cm ultrapassa23 cm a parede gráfica antes do corredor. Mover jantar também reduz folgas junto à geladeira. Nenhuma configuração completa aprovada: manter intenção de parede inteira e estudar seção/retorno mais compactos antes da imagem fiel. Alternativa de blackout de enrolar com tecido frontal mencionada apenas para futuro ensaio; não substitui automaticamente as duas camadas escolhidas. Modelo, móveis e site não alterados.

## Cortina cobrindo toda a parede da janela — 20/09/2026

Elias confirmou: “sim, quero q cubra a parede inteira, para dar sensação de sala grande”. A extensão de ponta a ponta da parede da janela passa a ser escolha aprovada para sala/jantar, substituindo a pendência de cobrir apenas o vão ou toda a parede. Mantidos trilho duplo discreto no teto, ondas suaves, comprimento até perto do piso e duas camadas independentes: tecido com aparência de linho off-white quente à frente e blackout claro atrás. Objetivo é sensação visual de amplitude; não alterar as dimensões da sala na futura imagem.

Próxima definição: sentido de abertura e distribuição do tecido recolhido, considerando sofá e painel/TV próximos às extremidades. Não registrar abertura central ou unilateral como aprovada. Largura/altura acabadas, afastamento do trilho, volume de tecido, amostras e instalação ainda a conferir. Escolha documentada localmente; nenhuma compra ou publicação nesta etapa.

## Espelho na sala e preparação da imagem — 20/09/2026

Elias respondeu “pode ser o espelho” à proposta para a parede externa do banheiro voltada à sala/jantar, e pediu registrar a escolha e seguir às decisões que faltam para uma imagem fiel. Confirmada a escolha de espelho nessa parede, com objetivo de sensação de amplitude. Direção visual apresentada: vertical, retangular com cantos arredondados, espelho prata e moldura fina no tom do Arenza. A referência de 70 × 120 cm é ponto de partida para simular, não dimensão executiva nem produto comprado; altura, tamanho final, espessura, fixação e enquadramento do reflexo continuam a conferir. Manter a parte inferior livre para uso da lixeira e circulação. Não garantir que refletirá o quadro e o pendente sem testar o ponto de vista.

O espelho não substitui a composição única do Caminho da Fé acima do banco e é distinto do espelho lateral do guarda-roupa. Criado Sala_e_jantar/Visualizacao_fiel_R00.md para consolidar referências atuais e separar decisões visuais de conferências físicas. Próximos pontos visuais: formato final do pedestal e extensão da cortina; compatibilizar quadro/espelho/pendente antes da imagem. Sem geração de imagem, alteração do modelo ou publicação externa nesta etapa.

## Tapete Almeidas escolhido — 20/09/2026

Elias confirmou “ok, almeidas como tapete”. Referência escolhida: Almeidas bege/off-white, pelo baixo, sem franjas, anúncio de140×200cm e R$269 sem cupom (preço pesquisado, sem frete). Substitui greige mesclado como direção visual do tapete. Conferir lavagem/peso/adequação à LG VC4, secagem e encaixe com sofá retrátil e banco antes da compra. Não considerar lavagem em máquina já validada nem alterar teto da iluminação de R$1.200. Detalhes e link em Sala_e_jantar/Tapete_R00.md.

## Quadro da sala — composição única confirmada — 20/09/2026

Elias respondeu “sim, composição unica” à proposta de reunir as quatro fotografias escolhidas de Fagner Martins, incluindo a placa, em um único quadro acima do banco. Confirmada composição única; adotar arranjo 2×2 como proposta de montagem apresentada. Moldura fina em madeira próxima ao Arenza, fundo off-white, espaçamento uniforme e cerca de 120×85cm continuam referências propostas, sem confirmação individual nem medida executiva. Preservar cores originais e a fotografia em P&B. Conferir proporções/recortes e interferência visual do pendente; arquivos originais e autorização de impressão/montagem pendentes. Não gerar substituições das fotografias escolhidas como se fossem obras do autor.

## Indireta como direção visual e conferência elétrica — 20/09/2026

Após esclarecimento de que a passagem elétrica é desconhecida, Elias respondeu “ok, seguimos”. Prosseguir com indireta quente acima da prateleira superior da TV como direção visual. Não registrar conduíte como existente: Elias disse “precisa existir, mas n sei”. Conferir em vistoria percurso aproveitável entre comando na entrada e painel; prever botão cabeado se viável ou comando sem fio na entrada. Controlador, fonte, perfil e orçamento completo ainda não fechados; teto R$1.200 preservado. A medida de 90–100cm e temperatura proposta de 3000K permanecem referências de estudo, não especificação executiva. Pendência adicionada ao índice da visita.

## Plafon escolhido e avanço para indireta — 19/09/2026

Elias aceitou a recomendação do **Taschibra Jurerê branco, redondo 30cm, vidro fosco, 2xE27** e pediu avançar para as indiretas. Registrar modelo como escolha de projeto; encaixe/ventilação das WiZ ainda pendentes de conferência. Teto do conjunto permanece R$1.200. Localização e componentes da indireta são propostas em desenvolvimento no estudo R01, não escolhas aprovadas por esta resposta.

## Novo teto para iluminação e pesquisa de plafon — 19/09/2026

Elias autorizou **até R$1.200 para o conjunto de iluminação de sala e jantar**, substituindo o teto de R$1.000, e pediu pesquisar o plafon. Mantidos frete/instalação separados e requisitos de branco/RGB, intensidade, Alexa e comando físico. Nenhum plafon aprovado neste momento. Pesquisa comparativa e orçamento parcial atualizados em Sala_e_jantar/Iluminacao_R01.md; preferência técnica/econômica inicial pelo Taschibra Jurerê 30cm 2xE27, condicionada à acomodação e ventilação das lâmpadas WiZ.

## Equipamentos Alexa existentes — 19/09/2026

Elias informou **Echo Dot e Echo Show 5**, sem especificar gerações. Aproveitar assistentes existentes para controle de voz da iluminação; não pressupor hub Zigbee nem adicionar novo Echo à lista. Seleção de dispositivos e controles físicos ainda pendente de compatibilidade; orçamentoR$1.000 mantido.

## Posição dos comandos de iluminação — 19/09/2026

Elias confirmou “comando na entrada da sala com possivel controle sem fio”. Comandos físicos na entrada aprovados como intenção de uso, mantendo smart; controle sem fio junto ao sofá é opcional, condicionado a preço/compatibilidade. Não implica autorização de alteração de pontos/estrutura, escolha de protocolo ou aumento do teto de R$1.000. Desenvolver conjunto completo no estudo Sala_e_jantar/Iluminacao_R01.md.

## Controle físico e smart da iluminação — 19/09/2026

Elias aprovou **controle físico também, além de smart**, após pergunta sobre ligar e regular as luzes pela parede. Incorporar requisito ao estudo da sala/jantar. Comandos independentes para pendente, luz geral e indireta como proposta funcional, com arquitetura/modelos e compatibilidade elétrica a definir. Não presumir que lâmpada G9 dimerizável seja smart ou que dimmer comum seja compatível com plafon inteligente. Orçamento aprovado permaneceR$1.000; eventual acréscimo deve ser apresentado, não presumido.

## Cenas de TV e filmes — 19/09/2026

Elias prefere **luz indireta na maioria das vezes e ambiente apagado para alguns filmes importantes**. Incorporar ambas as cenas ao estudo, com indireta, luz geral e pendente acionáveis separadamente. Não equivale à aprovação de localização/produto de fita ou novo orçamento. Comportamento da possível Ambilight nesse modo e escolha de controle físico ainda pendentes.

## Programa de iluminação — 19/09/2026

Elias definiu clima noturno **aconchegante, luz quente e suave, com alguns pontos de destaque**. Mesa também usada para estudar, ler e jogar, com pouca frequência: prever cena funcional além da decorativa. Aceita avaliar luz indireta no painel/prateleiras e possível acréscimo de custo com benefício claro; não aprovou valor extra, instalação específica ou novo teto. MantidosR$1.000 como orçamento aprovado. Estudo consolidado em Sala_e_jantar/Iluminacao_R01.md. Não depender do Arevo central compacto como única luz funcional da mesa nem duplicar automaticamente a possível Ambilight com fita atrás da TV.

## Orçamento de iluminação ampliado — 19/09/2026

Elias autorizou “pode subir orçamento pra 1.000 do conjunto”. Novo teto **R$1.000 para o conjunto de iluminação sala/jantar**, incluindo pendente Arevo âmbar, três lâmpadas G9, controle de intensidade/dimmer e iluminação principal inteligente da sala (RGB para colorir o ambiente, branco, intensidade e Alexa). Substitui o teto anterior de R$600; frete e instalação continuam separados conforme escopo anterior. Manter prioridade do pendente e custo-benefício, sem obrigação de consumir todo o teto. Não constitui compra nem aprovação da cascata moderada proposta na pergunta anterior.

Referência de cálculo, sem preço final garantido: Arevo âmbar R$359,73 + três G9 candidatas a R$28,71 = R$445,86; saldo **R$554,14** para dimmer e luz inteligente. Tensão do circuito, encaixe das G9 e compatibilidade de dimerização continuam pendentes.

## Pendente preferido — Arevo âmbar — 19/09/2026

**Conferência da variante e proposta seguinte:** navegador confirma VIDRO ÂMBAR variant_id=3381, referência específica **82P3A** (C82P3 é referência geral), R$399,70 ou **R$359,73 no boleto**. Foto mostra três globos em cascata sob canopla circular; não é barra horizontal. Proposta do assistente, ainda sem aprovação: um conjunto centralizado sobre a mesa, cascata moderada, luz quente3000K; alturas executivas dependem de pé-direito, folga entre globos e visão do quadro. Lâmpada candidata anunciada: Brilia Mini G9 3,5W3000K dimerizável127V314450, R$28,71 à vista por unidade na André Iluminação (https://www.andreiluminacao.com.br/lampadas-led/lampada-led-mini-g9-dimerizavel-3-5w-127v-314450-brilia). Três somam R$86,13, com pendente R$445,86; saldo R$154,14 dos R$600 ainda precisa cobrir dimmer e iluminação da sala. Não confirmado encaixe, tensão do circuito ou compatibilidade com dimmer; não é lista de compra fechada. Não prometer orçamento conjunto viável antes de completar seleção.

Elias respondeu “gostei do arevo vidro ambar” à comparação de pendentes. Registrar como preferência atual o **Arevo Jabuticaba triplo C82P3, estrutura preta fosca e três globos de vidro âmbar**, substituindo a barra linear preta como referência estética principal para o estudo da sala. Página: https://www.arevoiluminacao.com.br/pendentes/pendente-jabuticaba-2xg9-preto-fosco-2623 . Não constitui compra nem confirmação de preço da variante.

Ficha previamente consultada: três globos de 15cm, base de 20cm, três lâmpadas G9 não inclusas e suspensão ajustável. Validar composição/altura sobre mesa180×75cm, luz quente e conjunto compatível para regular intensidade. Preferência pelo âmbar não confirma desempenho de difusão, ausência de ofuscamento ou dimmer. Mantidos orçamento conjunto de R$600 sem frete/instalação e prioridade do pendente; luz principal inteligente RGB/branco/Alexa da sala a pesquisar depois. Preço final da variante e custo de lâmpadas/controle pendentes. Não gerar/publicar imagem definitiva antes de compatibilizar a composição.

## Pendentes em comparação — 19/09/2026

Elias gostou de duas propostas diferentes: Ohad 12cm âmbar com cristais K9 (https://www.lustresonline.com.br/produto/lustre-pendente-ohad-12cm-ambar-com-cristais-k9-legitimos.html) e Maze /3 preto (https://www.lustresgenesis.com.br/produtos/lustre-pendente-aramado-preto-infinito-maze-3-infinity-para-mesa-de-jantar-sala-de-estar-quartos-balcao-banheiroelavabo/). São candidatos, nenhum escolhido; reabre comparação estética além da barra linear anterior. Não interpretar como aprovação de lâmpadas expostas ou retirada do requisito de dimmer.

Páginas e fotos verificadas no navegador: Ohad R$399 por unidade, diâmetro12cm/altura8cm, cabo150cm ajustável, 1 G9 não inclusa. Duas peças custam R$798 e três R$1.197 antes de lâmpadas/frete/descontos. Maze variante60×20cm, altura20cm, 3 E27, R$412,30 ou R$379,32 à vista anunciado; lâmpadas de carbono anunciadas como brinde condicionado a seguir Instagram. Não foi seguida conta nem feito contato/compra. Dimmer e lâmpadas compatíveis não confirmados em ambos. Opinião do assistente: Maze mais alinhado ao pedestal preto e orçamento, mas aramado/lâmpadas aparentes adicionam informação visual diante do quadro; Ohad traz âmbar e brilho, com composição de várias unidades mais cara. Não alterar moodboard final até escolha.

## Sala e jantar — fechamento visual em 18/09/2026

**Iluminação — prioridade de compra revista:** Elias pediu pesquisar primeiro o pendente, buscando design e preço baixo, e depois uma luz inteligente mais barata para a sala. Priorizar o pendente na distribuição dos R$ 600 totais; nenhum aumento de orçamento aprovado. Preservar a direção linear preta fosca, luz difusa e regulagem de intensidade. Plafon LEDVANCE permanece apenas candidato e deixa de orientar a divisão do orçamento. Não retirar RGB principal, branco, intensidade e Alexa sem nova decisão.

**Detalhe confirmado na triagem BRDrop:** os 150cm do título referem-se à altura; a descrição informa comprimento de 100cm e largura 1,2cm. Alimentação 175–265V, explicitamente incompatível com 110/127V; verificar circuito antes de considerar. Não assumir comprimento de 150cm nem bivolt.

**Triagem de pendentes, sem escolha de produto:** Lumier Lumi35 LU34039-PT anunciado a R$ 299,20 na Lustres Online (https://www.lustresonline.com.br/pendente-lumier-lumi35-115cm-50w-3000k-preto-fosco): título 115cm/3000K, descrição mistura 120cm/4000K, sem confirmação de dimerização; referência econômica de design, exige esclarecer ficha. Fit Linear Gênesis (https://www.lustresgenesis.com.br/produtos/lustre-pendente-de-led-fit-linear-preto-80cm-para-sala-de-jantar-quartos-sala-de-estar-escritorios-e-apartamentos/): página na variante 100cm anuncia R$ 524,31 à vista, 3000K, sem confirmação de dimmer. BRDrop Linear 150cm (https://www.brdrop.com.br/produtos/pendente-lustre-linear-led-dimerizavel-c-controle-150cm/): R$ 635,55 Pix, anuncia controle/dimerização, excede sozinho orçamento total. Valores pesquisados em 18/09/2026, sujeitos a variante/frete; não são orçamentos fechados. Faixa de 100–120cm proposta para estudar sobre mesa de 180cm, não dimensão aprovada.

**Plafon — efeito RGB confirmado:** Elias escolheu “colorindo a sala”. Exigir **RGB na iluminação principal**, além de luz branca para uso cotidiano, ajuste de intensidade e compatibilidade Alexa. **RGB apenas na borda/halo no teto não atende**; o EKAZA EKHM-T5024R com borda RGB anteriormente apresentado não é selecionado para esse requisito. Mantido orçamento total de R$ 600 para plafon e pendente, sem frete/instalação. Fluxo e alcance reais no modo colorido dependem do modelo e precisam ser avaliados, sem equiparar lúmens brancos a lúmens RGB.

**Orçamento de iluminação aprovado:** Elias respondeu “pode ser 600 reais” à proposta de orçamento para **pendente do jantar + plafon inteligente da sala**, sem frete e instalação. Adotar **R$ 600 para os dois aparelhos juntos** como limite de seleção. Esta decisão substitui a ausência de teto numérico registrada anteriormente. Não constitui escolha do plafon EKAZA apresentado nem aceitação de RGB apenas na borda; preferência entre halo colorido no teto e luz principal colorida ainda pendente. Preservar os demais requisitos aprovados e conferir se o preço do pendente inclui o sistema necessário para regular intensidade.

**Orçamento de iluminação — preferência:** ao ser perguntado sobre valor total para pendente e plafon sem instalação, Elias respondeu “nao quero gastar mt”. Priorizar opções econômicas e custo-benefício; nenhum teto numérico aprovado. Preservar pendente linear preto fosco com luz difusa e intensidade regulável e plafon inteligente com cores/intensidade e Alexa. Não confundir ajuste de branco com RGB nem halo RGB periférico com iluminação colorida principal.

**Almofadas — formato aprovado:** Elias respondeu “sim” à proposta de **45 × 45 cm, lisas, com textura discreta e capas removíveis com zíper**. Mantidas duas unidades: uma greige e outra azul-petróleo discreto. Tecido/código, enchimento e produto ainda a escolher; lavagem depende da etiqueta, sem aprovação automática de lavagem em máquina.

**Almofadas do sofá — composição aprovada:** Elias respondeu “amei” à proposta de **apenas duas almofadas**, **uma greige e outra azul-petróleo discreto**, para conectar o sofá à cozinha sem carregar a sala. Quantidade e cores aprovadas; tamanhos, tecido, textura, enchimento e modelos ainda a definir. Sofá Bonnie bouclê bege-claro mantido.

**Rodapé da sala — direção aprovada:** Elias respondeu “sim, quero q o rodape de sensação se ambiente amplos” à proposta de rodapé **branco, liso, fosco, perfil reto e sem frisos**, com **7 cm de altura como referência inicial**. Prioridade: sensação de amplitude e acabamento discreto. Material, modelo, espessura, tom de branco e encontros com portas/móveis ainda a definir; 7 cm é base do estudo visual, não dimensão executiva liberada. Não estender automaticamente esta escolha aos outros cômodos. A aparência de amplitude é intenção estética, não ganho de espaço físico.

**Quadro — seleção de fotografias de Fagner Martins:** Elias escolheu três fotos do ensaio Caminho da Fé (https://www.behance.net/gallery/229576867/Caminho-da-F): módulo **1315385779**, ponte de madeira/riacho e paisagem rural; **1315385751**, estrada sinuosa entre montanhas em preto e branco; **1315385745**, estrada com ciclista ao longe entre cercas e montanhas. Pediu incluir, se houver espaço, a foto da placa “Você é o viajante mas também é a viagem”, enviada em anexo. Correspondência visual da quarta confirmada no grupo Project Module 30 da galeria; imagem pública: https://mir-s3-cdn-cf.behance.net/project_modules/1400_webp/6968a4229576867.6866e66c2da60.jpg . Captura enviada preservada em 03_Referencias/Caminho_da_Fe_Fagner_placa_referencia_2026-09-18.png. As quatro são horizontais, aproximadamente 3:2. Proposta do assistente: composição 2×2 em moldura única, cerca de 120×85 cm como estudo acima do banco de 180 cm; não aprovada nem validada com parede/pendente. Preservar P&B da segunda foto. Arquivos originais, autorização para impressão/montagem, orçamento e resolução final pendentes; nenhum contato externo realizado.

**Quadro Caminho da Fé — linguagem escolhida:** Elias respondeu “linguagem fotografica”. Confirmada **linguagem fotográfica** para a obra do Caminho da Fé de bicicleta na sala/jantar. Fotografia específica, trecho retratado, autoria/licença, dimensões e moldura continuam pendentes. Imagem horizontal com ciclista pequeno, montanhas/estrada, cores naturais e moldura fina próxima ao Arenza foi proposta, sem aprovação individual desses detalhes. Se for criada uma imagem sintética posteriormente, identificá-la como interpretação de linguagem fotográfica, não como registro documental de trecho real nem foto pessoal.

**Arte — temas e ambientes escolhidos:** Elias definiu **quadro do Caminho da Fé de bicicleta para a sala/jantar**, no contexto da parede acima do banco. Para o **escritório**, escolheu **uma arte de São Paulo cinematográfica e uma arte de Cyberpunk**. Obras/imagens específicas, autoria, técnica, dimensões, molduras e posições exatas ainda a escolher. Não inventar fotografia pessoal nem afirmar que Elias já percorreu o Caminho da Fé. A escolha dos temas substitui a exploração anterior de abstrato genérico e das alternativas de arte da sala.

**Quadro do jantar — revisão de direção:** Elias rejeitou a proposta de abstrato suave escolhido apenas para combinar com a paleta. Quer quadro ligado à própria personalidade. Referências pessoais fornecidas pertinentes à arte: ciclismo/MTB e cicloviagens, viagens com natureza/história/aventura, vivência em Campinas e São Paulo, jogos e estética cyberpunk/Mr. Robot. Tema, obra, formato, moldura e dimensões ainda não escolhidos; proposta anterior de abstrato areia/off-white/azul-petróleo não aprovada. Usar identidade pessoal como critério, sem converter automaticamente profissão, dados financeiros ou outros detalhes do perfil em elementos decorativos.

**Tapete — direção aceita para seleção:** Elias respondeu “acho q pode ser” à proposta de **greige claro mesclado, sem desenhos marcantes, trama baixa, sem pelos altos e sem franjas**. Tratar como direção visual aceita para procurar modelos, condicionada à limpeza doméstica fácil. Priorizar produto expressamente lavável em máquina, verificando etiqueta, manual da LG, volume e secagem viável em casa; nenhum modelo, dimensão, material específico ou cabimento na máquina foi aprovado/comprovado. Não transformar esta aceitação preliminar em compra ou seleção definitiva.

**Tapete da sala — preferência condicionada à limpeza doméstica:** Elias gosta de tapete, desde que consiga limpá-lo facilmente em casa, sem precisar levá-lo à lavanderia. Não presumir que aceita lavagem manual de peça grande ou que tapete cabe na lava e seca. Modelo, material, trama/altura, cor, dimensões e método de manutenção ainda a escolher; verificar instruções do fabricante, secagem, peso/volume se houver lavagem e compatibilidade com piso vinílico e abertura do sofá retrátil. A facilidade de limpeza é requisito para a seleção.

**Alexa na sala — confirmado:** Elias respondeu “sim” à compatibilidade com Alexa para o plafon inteligente da sala. Requisitos vigentes: plafon branco discreto, próximo ao teto, luz difusa, ajuste de intensidade e cores, **compatível com Alexa**, com comando separado do pendente. Modelo, protocolo, eventual central, potência/fluxo, dimensões e instalação ainda a selecionar. Esta confirmação encerra a pendência de assistente da sala registrada abaixo; não estende automaticamente Alexa ao pendente.

**Luz geral da sala — plafon inteligente aprovado:** Elias aprovou a solução de **plafon discreto, branco, próximo ao teto, com luz difusa e comando separado do pendente**, acrescentando que a luz da sala deve ser **inteligente, com ajuste de intensidade e cores**. Modelo, dimensões, potência/fluxo, qualidade da luz branca, faixa de brancos, protocolo, aplicativo/assistente e forma de comando ainda a selecionar. Não inferir compatibilidade Alexa aprovada para a sala apenas pelo requisito existente no escritório. O requisito inteligente/colorido refere-se à luz geral da sala; não estendê-lo automaticamente ao pendente do jantar, cuja intensidade regulável já foi aprovada. Compatibilizar comandos com o modelo escolhido, sem presumir uso de dimmer convencional.

**Pendente do jantar — direção aprovada:** Elias respondeu “eu gosto” à proposta de **pendente linear fino, com extremidades arredondadas, acabamento preto fosco**, orientado no comprimento da mesa. Aprovadas **luz difusa, sem lâmpadas expostas, e intensidade regulável**, para refeições/jogos e uso mais suave. Esta aprovação complementa a escolha de ter pendente registrada abaixo. Modelo comercial, comprimento, altura de instalação, temperatura de cor, potência, sistema de dimerização e compatibilidade elétrica continuam pendentes; nenhuma compra realizada.

**Iluminação do jantar — pendente escolhido:** Elias respondeu “pendente sobre a mesa”. Confirmada presença de pendente sobre a mesa de jantar. Modelo, formato, material/cor, dimensões, altura de instalação, fonte de luz, temperatura, dimerização e ponto elétrico ainda a definir. A resposta não aprova automaticamente um pendente linear nem um acabamento específico.

**Cortina da sala — composição aprovada:** Elias respondeu “perfeito, pode fechar” à solução em **duas camadas independentes**: tecido leve com aparência de linho **off-white quente na frente** e **blackout claro atrás**, trilho duplo discreto no teto, ondas suaves e comprimento até perto do piso. Filtrar a luz no cotidiano e fechar o blackout quando quiser escurecer. Esta aprovação substitui o status de solução ainda não escolhida registrado abaixo. Marca/modelo, códigos dos tecidos, medidas, volume recolhido, instalação e tratamento de frestas continuam a detalhar, especialmente junto ao painel/TV. Não afirmar escuridão total do ambiente nem compra realizada.

**Cortina da sala — requisitos:** Elias quer aparência **clean e clara**, permitindo filtrar a claridade no cotidiano e **escurecer quando precisar**. Não definiu percentual de bloqueio nem exigiu blackout total. Solução em duas camadas com acionamento independente será proposta; tecido, cor exata, trilho, dimensões e camadas ainda não aprovados. Compatibilizar volume da cortina com painel/TV e janela.

**Painel da TV — acabamentos aprovados:** Elias respondeu “sim” à composição com **painel liso off-white fosco, sem ripado, e prateleiras em Greenplac Arenza**, uma acima e outra abaixo da TV. Aprovada intenção de fixações e fios ocultos, com acesso à régua preservado. Código exato da chapa off-white, alturas, dimensões finais, fixação, ventilação dos aparelhos e compatibilização com Ambilight continuam pendentes. Esta aprovação fecha acabamentos antes tratados como referência; não retoma o arranjo histórico com ambas as prateleiras abaixo da TV.

**Tampo — composição aprovada:** Elias respondeu “gosto” à proposta de tampo no **tom Arenza do banco, acabamento fosco e borda visualmente fina**, preservando **180 × 75 cm e cantos R15 já aprovados**. A aprovação é da aparência; material construtivo/revestimento, espessura real, acabamento da borda, reforço e fixação ao pedestal ainda a especificar. Não interpretar “tom Arenza” como escolha automática de tampo em chapa MDF. Pedestal preto fosco mantido; compatibilidade com Lina e recolhimento 2+1 pendentes.

**Pedestal — acabamento confirmado:** Elias respondeu “preto fosco pode ser”. Confirmado acabamento **preto fosco** do pedestal central único da mesa. Pés das cadeiras permanecem em madeira no tom do Arenza. Coluna metálica estreita, chapa baixa retangular com cantos arredondados e reforço discreto sob o tampo são propostas de desenvolvimento, não aprovadas como dimensões ou estrutura. A resposta confirma a cor/acabamento; formato final, fornecedor, estabilidade e compatibilidade com a Lina no recolhimento 2+1 continuam pendentes.

**Preferência pela Lina e continuidade no pedestal:** Elias disse “gostei da lina, vamos ver o pedestal da mesa”, referindo-se à Lina Estofada da Versatile (página id=783). Registrar como modelo preferido para compatibilização, sem compra ou encaixe aprovado. Madeira no tom do Arenza preservada; acabamento comercial, tecido, preço e medidas detalhadas pendentes. Próxima etapa: pedestal central único da mesa 180 × 75 cm, mantendo cantos R15 e guarda 2+1. Preto/grafite continua escolha registrada da mesa; rejeição de preto anterior foi específica dos pés das cadeiras.

**Pesquisa de cadeiras nesta etapa:** Elias aceita valores acima de R$ 800 por cadeira se compensarem no conforto; não estabeleceu teto máximo. Triagem aponta Lina Estofada da Versatile (44 L × 47 P × 94 A cm, pés de madeira maciça, encosto estofado, opções de tecido, preço sob consulta) como candidata compacta. Fonte: https://versatilemoveis.com.br/produto.php?id=783 (conteúdo indexado; abertura direta indisponível). Alternativa Duna Ayla, madeira maciça de eucalipto, personalizável, 46 L × 56 P × 84 A cm; preço não confirmado: https://www.aylaambientes.com.br/cadeira-duna-em-madeira-estofada-off-white . Nenhum modelo aprovado. Faltam tom próximo ao Arenza, tecido, preço para três unidades, medidas do assento/pés, conforto presencial e encaixe com pedestal/sapata. O ensaio anterior usava largura 42 cm e inserção 38 cm; não prova o recolhimento 2+1 de nenhuma candidata. Não confundir Lina Versatile com Lina de outras marcas.

Elias escolheu **greige claro para o estofado do banco de jantar**, ao responder “greige claro” à comparação com bege próximo ao sofá. Cor aprovada para assento e encosto; tecido, fabricante, código, textura e amostra ainda a definir, preservando resistência e facilidade de limpeza. O sofá Bonnie permanece bouclê bege-claro.

**Aprovação posterior na mesma conversa:** Elias respondeu “pode ser, gostei” à composição recomendada: base em **Greenplac Arenza** e encosto com **três painéis largos e lisos em greige claro**, definidos por costuras discretas, sem vãos profundos, botões, gomos ou costuras contrastantes. Direção de estofado mais liso aprovada para equilibrar o bouclê do sofá. Tecido/código/amostra, espumas, dimensões e execução ainda a detalhar. Divisões do assento e acesso ao baú permanecem pendentes; não inferir três tampas a partir dos três painéis do encosto.

Objetivo desta etapa: fechar sala/jantar para imagem realista no moodboard; nenhuma imagem nova ou publicação nesta decisão.

**Cadeiras — continuação de 18/09/2026:** Elias rejeitou pés pretos e escolheu pés em madeira na mesma cor da madeira do conjunto. Usar Arenza como referência de tom, conferindo amostras do produto real; não presumir que pés estruturais sejam feitos da chapa Arenza. A escolha não altera o pedestal preto da mesa. Elias perguntou se encosto levemente curvo melhora conforto para permanecer muito tempo sentado; formato, modelo e tecido das cadeiras ainda não aprovados. Priorizar conforto prolongado na seleção, além do recolhimento 2+1 já escolhido.

## Comparação presencial do vinílico — 15/09/2026

**Confirmação posterior de Elias:** “deixe salvo olmo como preferência e os outros como opções”. Olmo 24192727 passa a preferência principal expressamente confirmada; Aveia 24176655 e Bétula 24176606 permanecem alternativas. Atualizados registro específico e resumo. Confirmação final por amostra e compra pendentes.

Elias gostou do Olmo e solicitou mais duas opções, totalizando três para visitar uma loja. Lista registrada em Pisos_e_rodapes.md: Tarkett Ambienta Design Olmo 24192727 (referência preferida), Ambienta Series Aveia 24176655 e Ambienta Series Bétula 24176606. Pedir amostras das versões LVT coladas, conferir ficha/capa de uso e comparar com Arenza, sob luz natural/artificial, incluindo visibilidade de cabelos pretos. Lista para avaliação; não equivale à escolha definitiva de cor ou compra. Site preservado.

## Piso vinílico — critérios reconfirmados em 15/09/2026

Elias confirma vinílico em toda a casa, inclusive cozinha, exceto banheiro e lavanderia. Quer madeira clara/quente, natural, sem muito contraste, compatível com Arenza, visual leve, resistência e longa durabilidade. Modelo escolhido em outra IA não recuperado; autoriza nova seleção e pede registro persistente. [Registro específico](Pisos_e_rodapes.md) preserva critérios e proposta Tarkett Ambienta Design Olmo como candidata, sem aprovação automática de modelo, colagem ou compra. Não reabrir a escolha de vinílico nem confundir laminado de entrega com acabamento final desejado.
...
As respostas de Elias e o briefing têm origem identificada. Uma recomendação do assistente não vira aprovação por aparecer em uma imagem ou em um resumo. A data acima é a data de registro, não a data presumida de cada decisão.

Esta revisão concilia o memorial v2, os estudos A01.2/A04.2/A04.3/A04.4, os HTMLs de levantamento, o registro v0.1 e as instruções atuais de Elias. Reúne escolhas confirmadas, alternativas, estudos, pendências e decisões substituídas, com seus IDs e fontes preservados. Preserva todos os IDs anteriores e as 28 respostas do canto alemão e preserva dez respostas iniciais da lavanderia, mais as escolhas complementares de F21. As versões 0.1 a 0.5 permanecem como histórico; usar este arquivo para continuidade. Por decisão de Elias, manter um registro por dia e sobrescrever o arquivo vigente durante o dia, sem gerar versão por resposta.
...
**Persistência e publicação:** arquivo local, sem publicação automática no GitHub/Drive. Este documento não faz afirmações sobre configurações de memória da aplicação. Compras e contratação não foram realizadas nesta conciliação.

### Situação da escolha × situação da execução

- **CONFIRMADO:** Confirmado por Elias ou declarado definido no briefing; não equivale a liberação para execução.
- **EM ESTUDO:** Proposta ou configuração ilustrativa em desenvolvimento; não é decisão executiva aprovada.
- **PENDENTE:** Escolha ou informação ainda não definida nas fontes disponíveis.
- **ALTERNATIVA:** Alternativa registrada, sem substituir a especificação principal.
- **SUBSTITUÍDO:** Registro histórico superado por correção expressa; não usar no projeto vigente.
...
## 2.1 Base disponível e limites das medidas

| Informação | Origem | Tratamento |
|---|---|---|
| Serviço: 129 cm paralelos à bancada e 154 cm transversais | Planta P01 / A01.2 / quadro A04.4 | Cotas documentais, sujeitas a acabamento e conferência; não inverter os eixos. |
| Cozinha: 352 cm longitudinais e 155 cm transversais | Mesmas fontes | Largura transversal não é corredor livre. Soma 129 + 352 = 481 cm exclui a faixa entre setores e não define comprimento da pedra. |
| Dormitórios 01 e 02: 2,45 × 2,95 m e 2,30 × 2,95 m | Planta oficial | Cotas documentais, não medidas acabadas conferidas. |
| Sala: 2,45 m no trecho superior e 5,15 m longitudinal | Planta oficial | 2,45 m não define largura da janela. |
| Banheiro: 2,09 × 1,24 m; circulação: 0,90 e 1,05 m | Planta oficial | Preservar referências da planta; não usar como aprovação de móveis ou passagem final. |
| HTMLs R01/R02 | Vídeo de outra unidade, espelhada | Evidências visuais, estimativas e relatos separados; eixos, funções ocultas, materiais e dimensões não confirmados na unidade de Elias. R02 corrige a classificação de quartos da R01. |
| Módulos de cozinha 40/80/75/65 cm e preparo de 80 cm | Proposta A04.4 R01 | Metas de estudo; não escolhas dimensionais fechadas nem medidas reais. |
| Canto alemão 1,50 × 1,20 m / 1,50 × 0,80 m | Imagens e histórico | Estimativas/render; não dimensões aprovadas. |
| Pé-direito, rebaixos, peitoril, shaft, grelhas, pontos e faixa entre setores | Sem levantamento próprio | Permanecem sem valor. Não preencher por escala visual, valores típicos ou vídeo. |

As reservas da VC4/IB6 em F14 foram transcritas de conferências anteriores. A04.5/F19 acrescenta consulta técnica dos candidatos a aquecedor, sem validar sua instalação. VC4: 64 cm livres de largura, 85,5 cm de altura livre mais nivelamento, pelo menos 72 cm parede–porta fechada e 120 cm até porta a 90°, sem pessoa. IB6: 80,1 cm livres de largura, 196,6 cm de altura mais nivelamento e pelo menos 84,75 cm parede–frente fechada. Painéis/apoios ficam fora dos vãos livres. Essas reservas não liberam marcenaria nem comprovam circulação. Consulte o quadro A04.4 para referências e condições completas.
...
#### GER-001 — Finalidade
**CONFIRMADO** · Fontes: F01 §15.

Desenvolver arquitetura e interiores do apartamento e organizar o projeto em um site intuitivo: escolhas, referências, documentação e o que falta.

**Execução/limite:** Escopo; sem cronograma ou orçamento aprovado.

#### GER-002 — Dimensão de contexto
**CONFIRMADO** · Fontes: F01 §3.

Apartamento de aproximadamente 40 m²; área e medidas executivas não confirmadas.

**Execução/limite:** Levantamento/documentação técnica pendentes.

#### GER-003 — Preservação de decisões
**CONFIRMADO** · Fontes: F01 abertura; §14.

Não alterar escolhas fechadas sem consultar Elias; lacunas permanecem pendências; não inventar medidas, equipamentos, cores ou soluções técnicas.

**Execução/limite:** Regra de condução.

#### GER-004 — Direção estética
**CONFIRMADO** · Fontes: F01 §3–4.

Moderna, funcional, acolhedora, sofisticada e atemporal; base clara e natural, madeira quente, azul profundo em pontos estratégicos, pedra clara, texturas naturais e detalhes escuros.

**Execução/limite:** Direção visual; amostras e aplicações específicas ainda precisam de compatibilização.

#### GER-005 — Linguagem de marcenaria
**CONFIRMADO** · Fontes: F01 §4–6; F02 Q7.

Regra geral: azul nos superiores e madeira clara nos inferiores. O quarto é exceção obrigatória sem azul; isso não escolhe automaticamente o acabamento do banco de jantar.

**Execução/limite:** Respeitar exceções e decisões específicas por ambiente.

#### GER-006 — Armazenamento transversal
**CONFIRMADO** · Fontes: F01 §11.

Explorar móveis multifuncionais e volumes subutilizados; itens diários acessíveis, estoque/sazonais em zonas altas e componentes técnicos ventilados e acessíveis.

**Execução/limite:** Detalhamento por ambiente pendente.
**Observação:** No canto alemão, prevalece a hierarquia local confirmada em JAN-001.

#### GER-007 — Iluminação
**CONFIRMADO** · Fontes: F01 §12.

Luz quente e acolhedora, indireta e integrada à marcenaria; pontos sob armários e conforto visual.

**Execução/limite:** Temperatura de cor numérica, circuitos, luminárias e pontos não definidos.

#### GER-008 — Documentação principal
**CONFIRMADO** · Fontes: F09; F10; F11; F16.

Memorial de decisões v2, de 08/09/2026, localizado e lido integralmente nesta conversa. Planta oficial e HTMLs disponíveis. Decisões posteriores dos estudos complementam o memorial.

**Execução/limite:** Não confundir documentação disponível com levantamento acabado da unidade.
**Histórico:** Encerra a pendência de localizar/ler o PDF registrada na v0.1.

### Materiais

#### MAT-001 — Marcenaria superior — geral
**CONFIRMADO** · Fontes: F01 §6.

Guararapes Azul Petróleo

**Execução/limite:** Fichas técnicas e disponibilidade a conferir antes de comprar; quantidades e aplicação executiva não liberadas.

#### MAT-002 — Alternativa à marcenaria superior
**ALTERNATIVA** · Fontes: F01 §6.

Duratex Azul Profundo

**Execução/limite:** Fichas técnicas e disponibilidade a conferir antes de comprar; quantidades e aplicação executiva não liberadas.
**Observação:** Não substitui automaticamente Guararapes Azul Petróleo.

#### MAT-003 — Marcenaria inferior — geral
**CONFIRMADO** · Fontes: F01 §6.
...
PL-01 — Eliane Iseo Marfim AC 90×90
...
PB-01 — Biancogres Travertino Reale Greige Satin 90×90

**Execução/limite:** Fichas técnicas e disponibilidade a conferir antes de comprar; quantidades e aplicação executiva não liberadas.

#### MAT-008 — Interior do box
**CONFIRMADO** · Fontes: F01 §6.

PB-01B — Biancogres Travertino Reale Greige EXT 90×90

**Execução/limite:** Fichas técnicas e disponibilidade a conferir antes de comprar; quantidades e aplicação executiva não liberadas.

#### MAT-009 — Parede focal do box
**CONFIRMADO** · Fontes: F01 §6.

RB-01 — Portobello Vivant Sauge Mate 7×24,4

**Execução/limite:** Fichas técnicas e disponibilidade a conferir antes de comprar; quantidades e aplicação executiva não liberadas.

#### MAT-010 — Metais e detalhes
**CONFIRMADO** · Fontes: F01 §6.
...
#### MAT-011 — Tinta disponível
**CONFIRMADO** · Fontes: F01; F09; F16.

Existe uma lata de 20 L de Algodão Egípcio disponível na família.

**Limite:** Estado, validade, linha exata, rendimento e suficiência ainda não conferidos; não presumir cobertura de todo o apartamento.

### Canto alemão

#### JAN-001 — Hierarquia de escolha
**CONFIRMADO** · Fontes: F02 Q20.

Circulação > número de lugares > armazenamento.

**Execução/limite:** Diretriz para comparar alternativas; não é medida de passagem.

#### JAN-002 — Capacidade ocasional
**CONFIRMADO** · Fontes: F02 Q2–3; F24 Q2; correção explícita F25.

Máximo de seis pessoas à mesa simultaneamente: cinco amigos mais Elias. Configuração desejada: três lugares no canto alemão e três cadeiras. Não somar o segundo morador a esse máximo. Mantida a aceitação de circulação temporariamente mais apertada nas visitas.

**Execução/limite:** Quantidade e distribuição funcional aprovadas; cabimento físico, conforto dos três lugares no banco, acesso aos assentos e circulação ainda dependem do layout dimensionado. Não representa liberação para fabricação.
**Histórico:** F25 corrige a interpretação anterior de F24 como 6–7 ou 7–8 pessoas. O programa vigente é de seis pessoas no máximo.

#### JAN-003 — Quantidade habitual de usuários
**CONFIRMADO** · Fontes: F02 Q2; F24 Q1.

Duas pessoas morarão no apartamento (resposta 1B). Dimensionar o uso cotidiano para dois moradores.

**Histórico:** F02 não informava a ocupação cotidiana; essa pendência foi encerrada por F24. Não pressupor hábitos ou necessidades específicas do segundo morador.

#### JAN-004 — Uso múltiplo
**CONFIRMADO** · Fontes: F02 Q5.

A mesa terá vários usos dentre os apresentados: refeições, notebook/trabalho ocasional, jogos e receber pessoas.

**Execução/limite:** Combinação exata e frequência de cada uso não especificadas.
**Observação:** Resposta E significa vários desses usos, não confirmação individual de todos.

#### JAN-005 — Formato do banco
**CONFIRMADO** · Fontes: F02 Q4; F26 Q7.

Preferência atual por três pessoas alinhadas no mesmo trecho do banco (7B). Priorizar banco reto no estudo de encaixe; não distribuir os três lugares como duas pessoas em um lado e uma no retorno.

**Execução/limite:** Comprimento útil, conforto e cabimento ainda pendentes. F02 admitia reto ou L conforme circulação; F26 orienta a disposição dos assentos sem aprovar dimensões executivas.

#### JAN-006 — Configuração ilustrativa atual
**EM ESTUDO** · Fontes: F04; F08; I03.

Banco reto junto à parede direita, sem retorno em L, usado na proposta e nas plantas ilustrativas subsequentes.

**Execução/limite:** Estudo visual solicitado; não é solução executiva validada.
**Próximo passo:** Priorizar banco reto com três pessoas alinhadas conforme F26; testar dimensões com a planta oficial e conferir medidas locais antes da fabricação.
**Observação:** A solicitação da imagem dá contexto ao estudo, mas não fecha automaticamente cada dimensão ou detalhe nele representado.

#### JAN-007 — Conforto
**CONFIRMADO** · Fontes: F02 Q6.

Banco e encosto bastante estofados.

**Execução/limite:** Espumas, espessuras e ergonomia ainda não especificadas.

#### JAN-008 — Encosto
**CONFIRMADO** · Fontes: F02 Q8; F03 Q1; Q7.

Encosto fixo estofado, visualmente dividido em 2 ou 3 painéis, de altura visual média.

**Execução/limite:** Quantidade final de painéis, altura, inclinação e espessuras dependem de dimensionamento.

#### JAN-009 — Tecido
**CONFIRMADO** · Fontes: F02 Q9.

Tecido de alta resistência e fácil limpeza; capas removíveis não foram exigidas.

**Execução/limite:** Marca, composição, textura e cor exata pendentes.

#### JAN-010 — Base do banco
**CONFIRMADO** · Fontes: F02 Q16.

Base fechada até o piso.

**Execução/limite:** Construção, encontro com piso, rodapé e acesso interno ainda não detalhados.
**Observação:** Base suspensa ou rodapé recuado não devem ser tratados como escolhas já aprovadas.

#### JAN-011 — Integração estética do banco
**CONFIRMADO** · Fontes: F02 Q7.

Comparar visualmente: Arenza como elemento principal; madeira apenas em tonalidade próxima; ou móvel independente.

**Execução/limite:** Comparação visual e escolha final pendentes.
**Próximo passo:** Apresentar as três alternativas sem trocar automaticamente a paleta já fechada da cozinha.

#### JAN-012 — Acabamento proposto
**EM ESTUDO** · Fontes: F08.

Base em Greenplac Arenza com estofado neutro greige/bege.

**Execução/limite:** Recomendação anterior do assistente; não houve escolha explícita entre as três alternativas.
**Próximo passo:** Validar acabamento por comparação visual/amostras.

#### JAN-013 — Mesa: aparência e tampo
**CONFIRMADO** · Fontes: F02 Q15; F03 Q5–6.

Mesa visualmente leve; tampo em madeira, com cantos bastante arredondados, reafirmados em F28/F29. **Proposta dimensional, ainda EM ESTUDO:** para o tampo de 180 × 75 cm, testar quatro cantos com raio de 10 cm (R100 mm), em arcos de 90°. Faixa alternativa R8–R12 cm; raio final não aprovado por Elias. Seis gabaritos de pratos de 28 cm cabem no desenho, sem comprovar conforto dos braços, cadeiras ou pedestal. Ver A04.6 R01, página 5.

**Execução/limite:** Espécie/acabamento de madeira, espessura e geometria final não definidos.

#### JAN-014 — Mesa: base
**CONFIRMADO** · Fontes: F02 Q14–15.

Pedestal central preto/grafite.

**Execução/limite:** Geometria, estabilidade, dimensões da base e compatibilidade com cadeiras dependem do modelo.

#### JAN-015 — Mesa: formato exato
**EM ESTUDO** · Fontes: F02 Q13; F03 Q6; F08.

Oval/racetrack ou retângulo muito arredondado como opções de estudo.

**Execução/limite:** Cantos arredondados confirmados; contorno e dimensões exatos não aprovados.

#### JAN-016 — Cadeiras
**CONFIRMADO** · Fontes: F02 Q17–18; F25; F26 Q1/Q8.

Três cadeiras sem braços, complementando os três lugares alinhados do canto alemão, para máximo de seis pessoas. No cotidiano, duas cadeiras junto à mesa e a terceira em outro ambiente (1B). Priorizar conforto e recolhimento sob o tampo (8A).

**Execução/limite:** Definir função e local real da terceira cadeira; não presumir espaço disponível em outro ambiente nem substituição da cadeira de trabalho. Posições durante visitas, dimensões e compatibilidade com a base da mesa ainda dependem do layout.
**Histórico:** Duas cadeiras nas imagens eram estudo. F25 definiu três no total; F26 esclareceu distribuição cotidiana e ausência de braços.

#### JAN-017 — Assento extra
**CONFIRMADO** · Fontes: F03 Q2; F26 Q1.

Trazer a terceira cadeira de outro ambiente para os encontros. Ela integra o conjunto de três cadeiras já definido; não é uma quarta cadeira nem sétimo lugar.

**Execução/limite:** Ambiente de origem, uso cotidiano e percurso de transporte ainda pendentes. Não foi escolhida cadeira dobrável.

#### JAN-018 — Conteúdo do banco
**CONFIRMADO** · Fontes: F02 Q10; F03 Q3–4.

Armazenamento para jogos de tabuleiro, acessórios de ciclismo e mochilas/malas; jogos com tamanhos variados; capacetes e lanternas citados depois.

**Execução/limite:** Dimensões e quantidade dos objetos ainda não levantadas.
**Observação:** F03 contém “mocinhas”, anteriormente interpretado como mochilas. A categoria mochilas/malas já está marcada em F02 Q10C; não usar o termo ambíguo para criar outro item.

#### JAN-019 — Escolha do acesso ao armazenamento
**CONFIRMADO** · Fontes: F02 Q11–12.

Elias delegou a escolha do mecanismo buscando volume e aceita levantar/remover a almofada para acessar itens pouco usados.

**Execução/limite:** Mecanismo específico não aprovado.
**Observação:** Maximizar volume não se sobrepõe à hierarquia JAN-001.

#### JAN-020 — Acesso proposto
**EM ESTUDO** · Fontes: F08.

Baú por tampas superiores independentes, ferragem assistida e divisórias removíveis/ajustáveis.

**Execução/limite:** Proposta, sem ferragens ou número de tampas aprovados.
**Próximo passo:** Compatibilizar abertura com mesa, encosto e peso; definir divisões a partir dos objetos.

#### JAN-021 — Parede
**CONFIRMADO** · Fontes: F03 Q8.

Composição discreta de arte + iluminação decorativa.

**Execução/limite:** Obra de arte, luminária, quantidade, implantação e pontos elétricos pendentes.

#### JAN-022 — Infraestrutura
**CONFIRMADO** · Fontes: F02 Q19.

Prever a possibilidade de infraestrutura e decidir recursos depois.

**Execução/limite:** Tomada, USB-C, iluminação integrada e instalação definitiva não aprovadas.
**Observação:** O registro não transforma o baú em estação de carregamento.

#### JAN-023 — Medida da referência
**CONFIRMADO** · Fontes: F02 Q1; I01.

1,50 × 1,20 m da planta é estimativa/render, não medida conferida.

**Execução/limite:** Sem validade executiva.

#### JAN-024 — Dimensões executivas
**PENDENTE** · Fontes: F02 Q1; F01 regra de não inventar medidas.

Comprimento/profundidade/altura do banco, mesa, passagem, posições de cadeiras e volume útil ainda não definidos.

**Execução/limite:** Levantamento e estudo medido pendentes.
**Próximo passo:** Medir parede, largura útil, relação com cozinha/sofá, porta de entrada e interferências.

### Cozinha

#### COZ-001 — Ordem dos equipamentos
**CONFIRMADO** · Fontes: F14; F15.

Da entrada à janela: geladeira → apoio da air fryer → preparo → pia/purificador → cooktop com forno abaixo → lava e seca → tanque/cesto → janela.

**Execução/limite:** Sequência escolhida; larguras e pontos permanecem a compatibilizar. Forno sob cooktop substitui a proposta anterior de forno sob preparo. Ver COZ-012 e P-011.

#### COZ-002 — Retirada da pedra junto ao banheiro
**CONFIRMADO** · Fontes: F05.

Eliminar a pedra/bancada que encosta na parede externa do banheiro, deixando apenas piso e circulação livre nesse trecho.

**Execução/limite:** Não é autorização para alterar paredes, estrutura ou instalações.
**Observação:** Não confundir esta retirada com a bancada contínua da parede da cozinha/lavanderia.

#### COZ-003 — Armários na vista superior
**CONFIRMADO** · Fontes: F05.

Não detalhar os armários superiores azuis nessa planta vista de cima.

**Execução/limite:** Regra de representação gráfica.
**Observação:** Os armários azuis continuam no projeto; não foram cancelados.

#### COZ-004 — Marcenaria e pedra
**CONFIRMADO** · Fontes: F01 §6–7.

Superiores azuis, inferiores em Greenplac Arenza e bancada em Granito Branco Itaúnas.

**Execução/limite:** Detalhamento e fichas técnicas pendentes.

#### COZ-005 — Cooktop
**CONFIRMADO** · Fontes: F14; F15.

Electrolux KE4GC, quatro bocas, vidro preto, a gás; GN confirmado e conversão prevista. Modelo escolhido em 09/09/2026; não comprado.

**Execução/limite:** Recorte, folgas, gás e instalação a compatibilizar; teto em ORC-002.

#### COZ-006 — Air fryer
**CONFIRMADO** · Fontes: F14.

Philips Walita Série 3000 RI9252 digital preta, 4,1 L totais (cesto de 2,6 L). Compra de aparelho novo menor; não levará o atual. Acesso diário permanente e painel digital confirmados.

**Execução/limite:** Tensão pendente; prever ventilação e abertura da gaveta. Uso habitual para duas pessoas não define número de moradores.

#### COZ-007 — Posição do gaveteiro
**CONFIRMADO** · Fontes: F06; F07.

Mover o gaveteiro da região sob o filtro de água para o módulo inferior sob a air fryer.

**Execução/limite:** Largura, altura, profundidade e ferragens pendentes.

#### COZ-008 — Gabinete da pia
**CONFIRMADO** · Fontes: F06; F07.

Duas portas lado a lado sob a pia principal, em vez de gavetas.

**Execução/limite:** Módulo, vãos internos e acesso às instalações a detalhar.

#### COZ-009 — Organização do gaveteiro
**PENDENTE** · Fontes: F07.

Quantidade e alturas das gavetas ainda não fechadas; Elias pediu primeiro respeitar o projeto e, na ausência de definição, uma solução usual no Brasil.

**Execução/limite:** Não foi pesquisado ou comprovado um padrão nacional predominante.
**Próximo passo:** Detalhar conforme objetos e medidas, mantendo a posição COZ-007 e as duas portas COZ-008.
**Observação:** Três gavetas e proporções desenhadas são ilustrativas, não uma especificação aprovada.

#### COZ-010 — Inventário dos equipamentos
**CONFIRMADO** · Fontes: F14; F15.

IB6 reconfirmada como oficial por F29. Demais modelos principais já escolhidos: KE4GC, Venax Totale Nero GIII 50 L, ME23P, Suggar Slim de Embutir como referência, RI9252, PE11X e LG VC4. Ver registros específicos.

**Execução/limite:** Não há compra registrada. Aquecedor, cuba e torneira ainda sem modelo escolhido. Cafeteira, liquidificador e sanduicheira previstos sem seleção solicitada.
**Histórico:** Substitui a pendência genérica de modelos da v0.1; marcas em renders continuam sem força de aprovação.
...
#### LAV-002 — Bancada contínua
**CONFIRMADO** · Fontes: F01 §9.

Pedra contínua visualmente desde o fim da geladeira até a parede da janela; apoio sobre a máquina pode ocupar toda a largura dela.

**Execução/limite:** Geometria real, apoios e detalhes construtivos não definidos.

#### LAV-003 — Pequeno apoio junto à janela
**CONFIRMADO** · Fontes: F01; F12; F14; F16.

Faixa de aproximadamente 15 cm de largura, em retorno em L junto à janela, para apoios ocasionais. Não é a largura da bancada sobre a máquina.

**Execução/limite:** Comprimento, altura, apoios e compatibilidade com a janela pendentes.

#### LAV-004 — Janela
**CONFIRMADO** · Fontes: F01 §9.

Parede da janela deve permanecer livre.

**Execução/limite:** Compatibilizar marcenaria, abertura, ventilação e área técnica sem obstrução.

#### LAV-005 — Tanque
**CONFIRMADO** · Fontes: F01 §9.

Tanque esculpido na pedra, mantendo continuidade do material.

**Execução/limite:** Medidas, execução e instalações não detalhadas.

#### LAV-006 — Cesto
**CONFIRMADO** · Fontes: F18; decisões anteriores preservadas.

Um cesto único sob o tanque, removível inteiro, extraível e transportável até a máquina, com ventilação discreta. Escolha 5A.

**Execução/limite:** Modelo, capacidade, vão útil e ferragens a compatibilizar com tanque e sifão; não adicionar segundo cesto sem nova decisão.

#### LAV-007 — Armários
**CONFIRMADO** · Fontes: F01 §9.

Armários aéreos e até o teto para estoque, panos, ferramentas e itens pouco usados; separar limpeza diária e estoque.

**Execução/limite:** Inventário e divisão interna pendentes.

#### LAV-008 — Varal oculto com descida
**CONFIRMADO** · Fontes: F18; decisões anteriores preservadas.

Uso ocasional, inclusive para cobertor leve de casal (1A). Elias deseja compartimento tipo gaveta acima do aquecedor, de onde puxa o varal para fora e o baixa até altura confortável (2A). Recolhido, deve ficar oculto.

**Execução/limite:** Posição acima do aquecedor é preferência de implantação, não solução tecnicamente validada. Verificar exaustão, afastamentos, percurso, carga de roupa molhada, mecanismo, estrutura e fixação. Não definir carga em kg nem garantir cabimento sem dados. Não dimensionar para edredom pesado/queen por inferência.

**Alternativa aceita (3A):** Se a posição preferida não comportar a solução com segurança, usar módulo aéreo vizinho com varal oculto. A aceitação é condicional; não transfere automaticamente sua posição.

#### LAV-009 — Aquecedor escondido
**CONFIRMADO** · Fontes: F18; decisões anteriores preservadas.

Aquecedor a gás GN mantido, escondido visualmente por armário ripado, conforme pedido expresso de Elias. Modelo ainda não escolhido; Rinnai E15/REU-E150 FEH segue candidato, E211 FEH somente comparação.

**Execução/limite:** Ventilação, exaustão, afastamentos, abertura para manutenção e materiais dependem do equipamento e da instalação. A intenção de ocultação não valida fechamento técnico. Compatibilizar com varal preferido acima e alternativa em módulo vizinho.

#### LAV-010 — Composição técnica
**CONFIRMADO** · Fontes: F01 §9.

Conjunto integrado em quatro zonas: lavagem; cesto/produtos inferiores; estoque/varal superiores; aquecedor. Azul superior e Arenza inferior são a preferência, subordinada à solução técnica.

**Execução/limite:** Desenho final depende de medidas reais e equipamentos.

#### LAV-011 — Armário ripado: intenção e detalhamento
**CONFIRMADO** · Fontes: F18; decisões anteriores preservadas.

Ocultar o aquecedor em armário ripado é intenção visual confirmada.

**Execução/limite:** Material/acabamento específico do ripado, espaçamento, área livre, afastamentos, abertura/remoção e configuração construtiva ainda não definidos nem validados. Azul superior e Arenza inferior permanecem como composição geral; não inferir acabamento específico do ripado.

**Histórico:** A intenção antes em estudo foi reiterada e confirmada; desenho técnico continua pendente.

### Quarto

#### QUA-001 — Proibição de azul
**CONFIRMADO** · Fontes: F01 §5–6; §16.

Não usar azul nos móveis do quarto, inclusive em sugestões, moodboards, renders e desenhos.

**Execução/limite:** Regra visual obrigatória.

#### QUA-002 — Atmosfera
**CONFIRMADO** · Fontes: F01 §5.

Madeira e tons claros/neutros; ambiente acolhedor, visualmente silencioso e voltado ao descanso.

**Execução/limite:** Composição específica da marcenaria pendente.

#### QUA-003 — Cabeceira e armazenamento
**CONFIRMADO** · Fontes: F01 §5.

Armazenamento acima da cabeceira para cobertas, edredons e itens volumosos, com integração à parede.

**Execução/limite:** Profundidade, portas, ferragens e segurança a detalhar sem comprometer ventilação, iluminação, portas ou conforto.

#### QUA-004 — Marcenaria final
**PENDENTE** · Fontes: F01 §6.

Composição e acabamentos específicos ainda não definidos, respeitando ausência de azul.

**Execução/limite:** Projeto e amostras pendentes.

### Sala de estar

#### SAL-001 — Sofá
**CONFIRMADO** · Fontes: F01 §8; F26 Q9–10 e inventário.

Sofá novo a comprar, com chaise móvel. Elias aceita reposicionar a chaise nos encontros, desde que tenha lugar definido (9A). Se houver disputa de espaço, priorizar reorganização temporária dos móveis nas visitas (10A).

**Execução/limite:** Modelo, medidas, tecido e posição alternativa da chaise não definidos. Não há aprovação para reduzir o sofá; primeiro testar reorganização preservando conforto e circulação.

#### SAL-002 — Composição
**CONFIRMADO** · Fontes: F01 §8.

Tons neutros, madeira, detalhes escuros, iluminação quente e integração visual com cozinha.

**Execução/limite:** Móveis, tapete, arte e demais objetos não especificados individualmente.

### Banheiro

#### BAN-001 — Atmosfera e materiais
**CONFIRMADO** · Fontes: F01 §6; §10.

Base greige/travertino, textura natural, pedra Branco Itaúnas e metais/detalhes pretos/grafite; preservar PB-01, PB-01B no box e RB-01 na parede focal do box.

**Execução/limite:** Detalhamento de superfícies e compatibilização pendentes.

#### BAN-002 — Execução
**CONFIRMADO** · Fontes: F01 §10.

Compatibilizar impermeabilização, caimentos, juntas, paginação, recortes, nichos, registros, manutenção, louças e metais.

**Execução/limite:** Nenhum dimensionamento técnico aprovado nesta consolidação.

### Infraestrutura

#### INF-001 — Tomadas para ar-condicionado portátil
**CONFIRMADO** · Fontes: F01 §13.

Solicitada uma tomada de 20 A em todos os cômodos.

**Execução/limite:** É requisito solicitado, não dimensionamento elétrico aprovado.
**Próximo passo:** Validar circuito, bitola, proteção, carga, posição e equipamentos com responsável técnico.

#### INF-002 — Acessos
**CONFIRMADO** · Fontes: F01 §13.

Móveis não podem bloquear registros, gás, inspeções, ventilação, drenos, tomadas, portas, janelas ou acessos técnicos.

**Execução/limite:** Verificar em cada desenho e no levantamento.

### Escritório

#### ESC-001 — Referência visual
**EM ESTUDO** · Fontes: I01.

Escritório, mesa, sofá-cama e TV aparecem na planta enviada; medidas e equipamentos da imagem não constituem especificações executivas confirmadas.

**Execução/limite:** Programa detalhado confirmado em ESC-003/F44; modelos, dimensões e implantação continuam a conferir. A referência visual não define o móvel de hóspedes nem a TV.

#### ESC-002 — PC existente
**CONFIRMADO** · Fontes: F01 §2.

Elias informa possuir PC com Ryzen 7 7800X3D e RTX 4070.

**Posição escolhida — F44:** gabinete do PC visível sobre a bancada (9A). Preservar ventilação e espaço de trabalho. Dimensões do gabinete/periféricos e implantação ainda não informadas.
**Observação:** Não pressupõe compra de outros equipamentos ou espaço adicional.

### Histórico

#### HIS-001 — Sequência invertida na planta gerada
**SUBSTITUÍDO** · Fontes: F05.

Imagem intermediária colocou a geladeira no lado errado da bancada em relação à entrada.

**Execução/limite:** Não utilizar como referência de layout.
**Observação:** Regra vigente: COZ-001.

#### HIS-002 — Pedra junto ao banheiro
**SUBSTITUÍDO** · Fontes: I01; F05.

A pedra/bancada junto à parede externa do banheiro presente na planta inicial foi explicitamente retirada por Elias.

**Execução/limite:** Não reinserir por copiar a planta anterior.
**Observação:** Regra vigente: COZ-002.

#### HIS-003 — Aquecedor omitido na imagem intermediária
**SUBSTITUÍDO** · Fontes: F06; F07.

A substituição visual do aquecedor por ripado sem equipamento foi corrigida por Elias.

**Execução/limite:** Não reutilizar como projeto vigente.
**Observação:** Regra vigente: LAV-009.

### Complementos conciliados nesta revisão

#### GER-009 — Programa de vida atual
**CONFIRMADO** · Fontes: F01; F12; F16; F24; correção F25.

Apartamento para dois moradores, eficiente, prático e bonito; cozinha para cozinhar de tudo; sala confortável; receber cinco amigos mais Elias, com máximo de seis pessoas à mesa; escritório para home office, gaming e itens de ciclismo. Aparência de casa moderna e organizada, sem aspecto clínico, frio ou carregado.

**Limite:** Três lugares no canto alemão e três cadeiras são a configuração desejada (JAN-002/016), ainda sem cabimento físico comprovado. A ocupação cotidiana de dois moradores não aumenta o máximo de seis pessoas estabelecido por Elias. F12/F16/F24 ficam como histórico onde houver divergência.

#### GER-010 — Condução por perguntas relevantes
**CONFIRMADO** · Fontes: F14; F16.

Perguntas diretamente na conversa, uma por vez, aguardando resposta; não presumir aprovação por silêncio. Abordagem generalista, sem questionários sobre quantidades pequenas de pratos ou itens. Resolver detalhes internos com critérios de projeto e consultar Elias sobre escolhas relevantes. Não reabrir escolhas encerradas.

**Limite:** Não solicitar repetidamente medidas ou documentos indisponíveis. Retomar pela lavanderia.

#### GER-011 — Perfil e referências pessoais
**CONFIRMADO** · Fontes: F01; F16.

Elias é economista pela PUC e Analista Financeiro Sênior no Santander Corporate/Atacado. Valoriza análise, comparações, trade-offs, custo-benefício e recomendações justificadas; interessa-se por tecnologia, IA, natureza e história. MTB, pedaladas longas, bikepacking, treino indoor, jogos de corrida/imersivos e jogos de tabuleiro orientam o programa.

**Limite:** Interesses não aprovam compras, simulador, servidor, automação ou armazenamento da bicicleta inteira.

#### GER-012 — Disponibilidade de medidas
**CONFIRMADO** · Fontes: F10; F11; F14; F16.

Elias confirma dispor somente dos HTMLs do projeto e da planta baixa oficial como base dimensional atual, sem medidas próprias conferidas. Estudos e estimativas não são levantamento real. Apartamento ainda não entregue e documentação complementar da construtora indisponível conforme F14.

**Próximo passo:** Continuar estudo funcional com base documental e campos pendentes, conferindo medidas quando houver acesso.

#### COZ-011 — Geladeira
**CONFIRMADO** · Fontes: F14; revisão F28 encerrada por F29.

Electrolux IB6 branca inverse, 400 L, reconfirmada por Elias como modelo oficial em 11/09/2026. Freezer de 125 L. Corpo com largura de 60,1 cm; reserva básica lateral corrigida para 80,1 cm (60,1 + 10 + 10), com painéis fora do vão. Mantidos os demais afastamentos e verificação de abertura/retirada de gavetas. Orçamento máximo informado: R$ 3.600, sem preço de compra confirmado.
...
Electrolux PE11X cinza/prata, bivolt, sobre bancada, escolhido. Versão branca PE11B foi rejeitada. Uso: 800 ml a cada quatro horas, sem exigir água muito gelada.

**Limite:** Possível variação de temperatura durante retirada da reserva de 0,8 L já registrada; conexões, pressão, ventilação e altura da garrafa pendentes.

#### COZ-016 — Lava-louças
**CONFIRMADO** · Fontes: F14.

Não incluir no projeto atual por decisão de Elias para preservar espaço.

**Limite:** Não é comprovação dimensional de impossibilidade. Não oferecer alternativa de bancada nem reservar módulo sem nova instrução.

#### COZ-017 — Pequenos aparelhos
**CONFIRMADO** · Fontes: F14; F24, inventário informado.

Prever cafeteira, liquidificador e sanduicheira, já registrados. Elias confirma possuir os aparelhos e utensílios exemplificados na rodada F24, incluindo batedeira e panela de pressão; exclui formas grandes e panelas gigantes. Panelas especiais foram incluídas na resposta geral, sem tipos ou quantidades detalhados. Seleção de modelos desses pequenos aparelhos dispensada anteriormente.

**Limite:** Organizar guarda e uso sem presumir dimensões, potência ou compras. O inventário não significa deixar todos os aparelhos permanentemente sobre a bancada.

#### COZ-018 — Hábitos de cocção
**CONFIRMADO** · Fontes: F14.

Usa 3–4 panelas pequenas simultaneamente; não usa recipiente com diâmetro abaixo de 12 cm. Frituras em óleo aproximadamente duas vezes por semana; ruído do depurador incomoda pouco. Incômodo com entupimento e redução de chama no fogão atual, sem diagnóstico da causa.

**Limite:** Cabimento das panelas e desempenho futuro não comprovados.

#### COZ-019 — Preparos do forno e air fryer
**CONFIRMADO** · Fontes: F14.

Forno compacto para bolo, pernil de aproximadamente 1,2 kg, pão de queijo e pizza. Forma de pizza de 30 cm aceita, substituindo 35 cm. Air fryer para frango, carne, hambúrguer e pão de queijo, habitualmente duas pessoas por preparo.

**Limite:** Outras assadeiras não medidas; observar medida externa da forma. Esses hábitos não definem dimensões do móvel.

#### COZ-020 — Lixeira da pia
**CONFIRMADO** · Fontes: F14; F15.

Uma lixeira para lixo comum escondida no gabinete da pia, que desliza para fora ao abrir a porta. Não prever segundo recipiente para recicláveis na pia.

**Limite:** Ferragem acionada pela porta, capacidade e implantação a detalhar com duas portas já escolhidas, cuba e sifão. Lixeira reciclável fica na lavanderia.

#### COZ-021 — Escorredor
**CONFIRMADO** · Fontes: F14; F15; F24 Q8.

Escorredor removível sobre a cuba, guardado após o uso (8A), sem escorredor no aéreo. Mantidos os hábitos anteriores: deixa louça secando, não acumula várias refeições e não seca panelas/formas nele.

**Limite:** Modelo, apoio, dimensões e lugar de guarda pendentes. Não presumir estrutura elevada. Manter área de preparo livre.

#### COZ-022 — Panelas
**CONFIRMADO** · Fontes: F14; F15.

Guardar panelas empilhadas em gavetões, tampas separadas.

**Limite:** Sob preparo é localização proposta; quantidade, alturas, ferragens e divisória de tampas ainda não aprovadas.

#### COZ-023 — Mantimentos
**CONFIRMADO** · Fontes: F14; F15; F24 Q6.

Compras quinzenais, mantendo 1–2 itens de reserva enquanto há um aberto. Mantida a informação anterior de ocasionalmente guardar 12 caixinhas de leite, podendo retirar a embalagem externa e organizar as caixinhas individualmente.

**Limite:** Categorias, volumes unitários e cargas não informados. O cabimento da reserva por item depende do inventário; não equivale a aprovação de volume de armários. Guarda inferior do leite é proposta, sem ocupar automaticamente os gavetões.

#### COZ-024 — Cuba, torneira extensível e tábua
**CONFIRMADO** · Fontes: F14; F15; atualizações F31 e F33.

Perfil escolhido: cuba única de inox, retangular com cantos internos arredondados; tamanho equilibrado para lavar panela de pressão e cesta da air fryer, sem buscar a menor cuba possível. Torneira com ducha extensível e aparência discreta, sem molas aparentes envolvendo a mangueira (F35). Araguari rejeitada pelo desenho. Tábua removível cobrindo parte da cuba para manter acesso à água; guarda vertical no gabinete depois de limpa e seca, compatibilizada com sifão e lixeira.

**Orçamento vigente:** até R$ 1.500 para cuba + torneira com ducha extensível + tábua, priorizando qualidade e custo-benefício. Substitui o teto anterior de R$ 550 para cuba e torneira. Não constitui compra ou ampliação automática de outros tetos.

**Cuba definida — F33:** Tramontina Dora 40 BL R6, referência 94017/113 (94017113), inox escovado, com válvula e escape; dimensão nominal 40 × 34 cm e profundidade de 18,5 cm, instalação por baixo da pedra. Escolha aprovada por Elias; compra não realizada. Cabimento integral do cesto da RI9252, incluindo puxador, ainda não comprovado.

**Torneira definida — F36:** Pingoo Apurema preta, EAN 7898689033906, extensível 50 cm, acabamento preto fosco, jato único conforme anúncio consultado. Elias aprova o modelo e seu visual discreto, sem molas aparentes. Compra não realizada. Compatibilizar pressão, altura, avanço e percurso de mangueira/contrapeso com a Dora, aéreo, sifão, lixeira e guarda da tábua.

**Rotina e integração da pia — F42:** pegar água pode exigir espera/passagem durante a lavagem; apoio do PE11X em Arenza com aparência fina, estrutura a dimensionar; abertura local no aéreo com ventilação/manutenção; escorredor removível guardado após secagem, local de guarda pendente. Priorizar conforto e estudar outra posição do PE11X se a lateral interferir na lavagem ou no afastamento do calor. Alternância entre tábua e escorredor confirmada por F43: aceita retirar o escorredor para usar a tábua, sem exigir uso simultâneo.

**Tábua parcial definida — F37:** madeira própria para contato com alimentos; cobertura de aproximadamente metade da abertura da Dora; uso para frutas, legumes, pães e montagem, com carnes cruas em outra tábua. Preferência por posicionamento à esquerda ou à direita, condicionada a apoios estáveis nos dois lados. Removível, guardada verticalmente após limpa e seca. Respostas de Elias: 1A/2A/3A/4A. Espécie de madeira, acabamento, espessura, dimensões, travas, fornecedor e preço ainda pendentes. A aprovação não valida encaixe ou largura de fabricação.

**Pendências:** especificação final da tábua, conferência do envelope externo e gabarito de recorte da cuba, apoios na pedra, material da tábua, pressão e alimentação da torneira, espaço de mangueira/contrapeso, sifão e acessórios. Frete e mão de obra ainda sem definição; apresentar separadamente na comparação. Preservar linguagem de metais preto/grafite já definida, sem presumir mudança de acabamento. Não alterar largura da zona da pia nem tratar a tábua como apoio para air fryer quente sem validação.

**Histórico:** F31 corresponde a 1A/2A/3C/4A/5A/6A/7A/8B/9C, seguido do novo teto explícito de R$ 1.500. Naquela etapa os modelos estavam sem escolha. F33 fecha a cuba Dora; a torneira foi posteriormente definida em F36 e o perfil da tábua em F37; especificação final da tábua pendente.

**Estudo F32 — atualizado pela aprovação F33:** [Seleção preliminar de cuba, torneira e tábua](Cozinha/Cuba_torneira_e_tabua_R00.md). Dora 40 BL R6 definida por F33 e Pingoo Apurema preta definida por F36; perfil da tábua parcial definido por F37, com especificação e encaixe ainda pendentes. Orçamento parcial e provisões separados. Redução da zona da pia de 75 para 60 cm é hipótese, ainda dependente do purificador e das interferências.

#### LAV-012 — Recicláveis
**CONFIRMADO** · Fontes: F18; decisões anteriores preservadas.

Recipiente removível para recicláveis escondido em módulo próprio (6A), um pouco maior que a lixeira comum da cozinha conforme decisão anterior. Separado do cesto de roupas.

**Execução/limite:** Capacidade, modelo, posição e cabimento pendentes. Não pressupor espaço sob o tanque nem sacrificar circulação ou manutenção.

#### LAV-013 — Rotina de secagem
**CONFIRMADO** · Fontes: F18; decisões anteriores preservadas.

Lava e seca como recurso principal; varal ocasional, inclusive para cobertor leve de casal.

**Histórico:** Responde à pergunta que estava pendente na v0.2.
**Execução/limite:** Não implica secar toda categoria de tecido na máquina; capacidade útil do varal e compatibilidade das peças dependem do detalhamento.

#### BAN-003 — Ducha escolhida
**CONFIRMADO** · Fontes: F14.

Addra Livo Black Matte, de parede, com desviador e duchinha de mão; referências BRS2003-BK / SKU 2193038. Escolha concluída; não comprada.

**Limite:** Pressão, curva de vazão, instalação e garantia específica ainda pendentes; não substituir por alternativa pesquisada.

#### BAN-004 — Preferências de banho
**CONFIRMADO** · Fontes: F12; F14.

Prioriza jato firme e boa distribuição. Referências de 45 °C no inverno, água quente sem mistura fria, e 37 °C no verão. Duchinha de mão desejada. Não requer banho e torneira quente simultâneos.

**Limite:** Preferências declaradas, não condições medidas nem validação de aquecedor.

#### INF-003 — Gás e tensões
**CONFIRMADO** · Fontes: F14.

GN confirmado por Elias. Tensões da VC4, forno, micro-ondas, depurador e air fryer continuam abertas. IB6 e PE11X registrados como bivolt/automáticos conforme fontes.
...
**Limites:** bancada, cadeira, móvel de hóspedes, equipamentos adicionais e orçamento não definidos. Testar acomodação de duas pessoas com abertura de porta, circulação, cadeira, PC e volante guardado. F45 dispensa uso simultâneo da estação e da cama aberta. Preservar acesso seguro para os hóspedes e espaço previsto para cadeira, volante e pedais recolhidos. Guarda de acessórios no escritório não cancela automaticamente a guarda já prevista no banco de jantar. PC existente Ryzen 7 7800X3D e RTX 4070 preservado em ESC-002.

#### ORC-001 — Equipamentos de geladeira e lavanderia
**CONFIRMADO** · Fontes: F12; F13; F14.

Teto de R$ 10.000 para geladeira + lava e seca + aquecedor, sem instalação; pagamento parcelado.

**Referências históricas de 09/09/2026:** IB6 R$ 3.699; VC4 R$ 4.599; E15 candidato R$ 2.446,70. Total R$ 10.744,70, R$ 744,70 acima do teto. Após IB6 + VC4 restariam R$ 1.702 para aquecedor. Frete, kits e adaptações não incorporados como cotação final. Não há aumento autorizado nem compra.

#### ORC-002 — Tetos específicos
**CONFIRMADO** · Fontes: F14; F15.

Tetos separados, sem ampliar os R$ 10.000: cooktop R$ 950; forno R$ 1.050 somente aparelho; micro-ondas R$ 540; depurador R$ 800; air fryer R$ 650; purificador R$ 600; ducha R$ 850 sem registros/instalação; cuba + torneira extensível + tábua R$ 1.500, atualizado por F31 (substitui R$ 550).

**Limite:** Forno com frete, instalação e conversão à parte; demais inclusões não esclarecidas permanecem abertas. Não constituem orçamento global da obra.

#### ORC-003 — Preços e compras
**CONFIRMADO** · Fontes: F14.

Histórico de 09/09/2026, sem nova cotação: KE4GC R$ 849; Venax R$ 922,83 parcelado; ME23P R$ 529; RI9252 R$ 494,99; PE11X R$ 549,90; Addra Livo R$ 593,28. Suggar sem oferta disponível no teto confirmada na pesquisa.

**Limite:** Preços, parcelas, estoques e fretes não são atuais ou garantidos. Conferir antes de compra; nenhuma compra registrada.

### Complementos da lavanderia — rodada F18

#### LAV-014 — Uso do tanque
**CONFIRMADO** · Fontes: F18; decisões anteriores preservadas.

Tanque esculpido para peças pequenas e panos, além de tênis e acessórios de ciclismo (4B).

**Execução/limite:** Espaço útil, profundidade e execução pendentes. Não foi solicitada capacidade para deixar peças grandes de molho.

#### LAV-015 — Guarda e estoque de limpeza
**CONFIRMADO** · Fontes: F18; F21; correção F22.

Guardar produtos, panos e ferramentas pequenas; produto em uso e uma reposição. Vassoura, rodo e mop passam a ter guarda horizontal solicitada na base da cozinha, conforme COZ-025.

**Histórico:** F18/F21 previam os itens longos na lavanderia; F22 solicita alternativa na cozinha para reduzir ocupação. Dimensões dos itens e cabimento ainda pendentes; não presumir cabos desmontáveis.

#### LAV-016 — Uso da bancada
**CONFIRMADO** · Fontes: F18; decisões anteriores preservadas.

Bancada para apoio rápido de cesto e produtos (9B), sem exigir área dedicada para dobrar roupa. Pedra contínua, tanque esculpido e retorno aproximado de 15 cm permanecem.

**Execução/limite:** Apoios e dimensões dependem da compatibilização.

#### LAV-017 — Aparência com tudo guardado
**CONFIRMADO** · Fontes: F18; decisões anteriores preservadas.

Produtos e acessórios escondidos, frente da lava e seca aparente (10A). Aquecedor oculto por armário ripado e varal oculto quando recolhido.

**Execução/limite:** Não prever porta para esconder a frente da máquina. Manter acessos técnicos e ventilação.

### Estudo de fixação e aquecedor — F19

#### LAV-018 — Robustez maior solicitada
**CONFIRMADO** · Fontes: F19, pedido de Elias.

Elias solicitou estudar fixação, carga e compatibilidade com aquecedor, preferindo dimensionamento para carga maior. Preservar varal oculto com descida e a alternativa de módulo vizinho já aceita.

**Limite:** O usuário não definiu um valor em kg, um mecanismo ou uma dimensão executiva.

#### LAV-019 — Meta de carga e geometria propostas
**EM ESTUDO** · Fontes: F19; A04.5 R00.

Meta de 30 kg úteis de roupa molhada distribuída agora confirmada por Elias em F21. A grelha inicial de 100 × 50 cm e a opção de 120 × 50 cm continuam propostas condicionadas ao cabimento; não foram aprovadas como dimensões executivas. Chassi próprio e retenção contra queda; marcenaria como acabamento, sem transferir esforços ao aquecedor/duto/conexões.

**Limite:** Não é capacidade instalada. Peso próprio e ações de movimento devem entrar no dimensionamento. Nicho fechado, mecanismo, perfis e ancoragens permanecem sem especificação executiva. A04.5 apresenta memória de esforços ilustrativa, não cálculo final de resistência.

#### LAV-020 — Resultado da compatibilização preliminar
**EM ESTUDO** · Fontes: F19; A04.5 R00; manuais oficiais consultados.

A posição acima do aquecedor não teve cabimento comprovado: exaustão, afastamentos, trajeto do varal e roupa molhada precisam de volumes próprios. Módulo vizinho é a recomendação preliminar, sem alteração automática do layout. O ensaio de volumes separados lado a lado excede os 129 cm documentais da lavanderia, podendo exigir estudo na transição para a cozinha.

**Limite:** Armário ripado continua intenção confirmada, mas porta aberta para manutenção não prova atendimento ao afastamento frontal de funcionamento registrado no manual E15. Não selecionar E15/E21 nem reduzir afastamentos por conta própria. E21 também é de circuito aberto; não é solução automaticamente compatível. Referências de varal consultadas: Mad até 20 kg e Foxydry Air até 35 kg, nenhum aprovado como conjunto de gaveta com descida e 30 kg.

#### LAV-021 — Alternativa de suspensão pelo teto e limite de furação
**EM ESTUDO** · Fontes: F20, manifestação de Elias nesta conversa.

Elias considera que acima do aquecedor talvez só seja possível com o varal preso ao teto e informa que a parede do aquecedor não pode receber furos com profundidade superior a 3 cm. Adotar essa restrição como informação do usuário para o estudo, sem tratar profundidades menores como automaticamente autorizadas ou suficientes. O HTML R02 registra aviso semelhante na unidade filmada, com aplicabilidade à unidade própria ainda sem conferência documental.

**Recomendação atual:** priorizar estudo de suspensão independente no teto, ancorada em laje ou estrutura resistente identificada e apta, preservando possibilidade de ocultação. Não pressupor que forro de gesso sustente o conjunto, nem que a laje possa receber furos em qualquer ponto. Tipo/espessura da estrutura, armaduras/cabos, instalações, regras da construtora e ancoragem ainda a verificar.

**Limite:** Alterar o suporte não elimina interferência de roupa/varal com aquecedor e duto. Estudar posição deslocada da área técnica e percurso completo carregado; ocultação, gaveta, descida e 30 kg continuam requisitos/propostas com os estados anteriores. Elias não aprovou varal permanentemente visível nem cancelou a intenção do armário ripado.

### Lavanderia — escolhas de acabamento e operação, F21

#### LAV-022 — Ocultação e testeira
**CONFIRMADO** · Fontes: F21.

Varal recolhido atrás de testeira alinhada aos armários (opção B), com sustentação independente. Testeira em Greenplac Arenza (3b), para marcar visualmente o término da cozinha e o início da lavanderia, conforme justificativa expressa de Elias.

**Limite:** Exceção específica à regra de azul superior; não altera automaticamente os demais aéreos nem define o acabamento do ripado do aquecedor. Altura, posição, recuos e percurso do varal pendentes. A ocultação aprovada passa a ser por testeira; não exigir compartimento fechado de gaveta como solução obrigatória. Necessidade de extração horizontal depende do mecanismo e do layout.

#### LAV-023 — Carga e acionamento
**CONFIRMADO** · Fontes: F21.

Manivela com redução e trava (opção A), removível e guardada em suporte dentro do armário (2a). Manter meta de 30 kg de roupa molhada (1A).

**Limite:** Capacidade é requisito a comprovar no conjunto, não carga instalada garantida. Encaixe, acessibilidade, força de operação, mecanismo e fixação ainda a verificar. Não adotar motor nem reduzir para 20 kg sem nova decisão.

#### LAV-024 — Acesso à limpeza e recicláveis
**CONFIRMADO** · Fontes: F18; F21; correção F22.

A solicitação de gaveta horizontal longa na base da cozinha substitui o compartimento vertical exclusivo de vassoura/rodo/mop na lavanderia. Recicláveis: abrir a porta e retirar recipiente pela alça, preservando a escolha anterior.

**Limite:** A preocupação atual de Elias com espaço não cancela o cesto de roupas nem a lixeira de recicláveis. Cabimento e posição desta última continuam abertos. Não afirmar que a lavanderia está dimensionalmente fechada.

#### LAV-025 — Porta ripada e investimento
**CONFIRMADO** · Fontes: F21.

Armário ripado do aquecedor com porta de abrir e possibilidade de remoção técnica (6a). Investimento: equilibrar custo e resultado, admitindo acabamento sob medida (7b).

**Limite:** Giro, ventilação, afastamentos e material do ripado ainda a compatibilizar. Porta removível não valida fechamento durante funcionamento. Não há teto monetário novo ou autorização de contratação/compra.

#### COZ-025 — Gaveta horizontal para itens longos de limpeza
**CONFIRMADO** · Fontes: F22, solicitação de Elias.

Estudar gaveta baixa, fina e longa sob o móvel da cozinha para guardar vassoura, rodo e itens semelhantes, preservando espaço para os pés ao lavar louça. Substitui a guarda vertical desses itens na lavanderia.

**Execução/limite:** Pedido funcional aprovado, não cabimento. Frente recuada quando fechada, sem puxador saliente na região dos pés; recuo e altura livre a definir em conjunto. Uma fresta de poucos centímetros junto ao chão não comprova conforto. Testar preferencialmente sob módulos secos de apoio/preparo, sem bloquear pés estruturais, painéis, tubulações, lixeira da pia, ventilação do forno ou manutenção. Comprimento útil e altura dependem dos cabos e cabeças reais; não presumir desmontagem, telescopia ou espaço livre contínuo sob módulos. Prever fundo removível lavável e secagem dos utensílios antes da guarda; mecanismo e posição exatos são propostas a detalhar.

#### COZ-026 — Altura provisória da bancada contínua
**CONFIRMADO** · Fontes: F23, aprovação provisória de Elias.

Adotar por enquanto 92 cm do piso acabado até a superfície superior da pedra da cozinha/lavanderia. Elias informa ter 1,75 m e está sem trena no momento. A altura poderá ser alterada após medir a distância do chão à parte inferior do cotovelo, em pé, com ombros relaxados e braço dobrado a 90°, considerando seu calçado habitual em casa.

**Execução/limite:** Valor provisório para desenvolvimento do projeto, não medida oficial da unidade nem altura liberada para fabricação. Confirmar conforto de preparo, pia e cooktop após a medição. Compatibilizar espessura e apoios da pedra, vão livre e nivelamento da lava e seca, forno/cooktop e espaço dos pés. Não elevar a bancada apenas para encaixar a gaveta de limpeza.

#### COZ-027 — Rotina de preparo e prioridade da bancada
**CONFIRMADO** · Fontes: F24 Q3–5.

Refeições rápidas durante a semana e receitas elaboradas ocasionalmente (3A). Normalmente Elias cozinha sozinho (4A). Priorizar área livre para cortar, montar pratos e preparar massas quando houver disputa por espaço (5A), preservando a air fryer acessível como já decidido.

**Limite:** Não confirma comprimento de bancada nem posição permanente de outros aparelhos. Compatibilizar guarda acessível dos equipamentos com o espaço de preparo.

#### COZ-028 — Louças de uso diário e para receber
**CONFIRMADO** · Fontes: F24 Q7.

Manter louças diárias e um conjunto separado para receber (7B).

**Limite:** Quantidades, dimensões e composição dos conjuntos ainda não informadas. Prever guarda para ambos sem presumir cabimento nos módulos atuais; conciliar com a capacidade de refeições em JAN-002.

#### JAN-025 — Mesa e reorganização para receber
**CONFIRMADO** · Fontes: F26 Q2–3/Q10.

Aceita deslocar um pouco a mesa nos encontros (2A). Priorizar tampo fixo; avaliar mesa extensível somente se a solução fixa não funcionar (3C). Diante de disputa entre sala e jantar, estudar primeiro reorganização temporária nas visitas (10A).

**Execução/limite:** Posição cotidiana e posição para seis pessoas devem ser desenhadas. Extensão e redução de sofá não estão aprovadas automaticamente. Preservar aparência, cantos arredondados e base de mesa já escolhidos, sujeitos à compatibilização.

#### JAN-026 — Refeições prolongadas e acesso ao banco
**CONFIRMADO** · Fontes: F26 Q4–6.

Servir comida na bancada, deixando a mesa para pratos e copos (4B). Encontros à mesa duram duas horas ou mais, conversando ou jogando (5B). Aceita que uma pessoa precise se levantar para outra sair do banco durante as visitas (6A).

**Execução/limite:** Reservar apoio na cozinha para servir. A concessão de acesso não dispensa conforto dos seis assentos nem circulação viável; testar uso prolongado, pernas e ombros. Jogos específicos e área necessária não informados.

#### INV-001 — Móveis e TV existentes
**CONFIRMADO** · Fontes: F26, resposta livre.

Elias possui cama queen e TV de 43 polegadas. Mesa, cadeiras e sofá serão comprados novos; no contexto desta rodada, os demais móveis serão novos.

**Execução/limite:** Medidas externas da cama/base/cabeceira, modelo e dimensões externas da TV e ambiente de instalação da TV não informados. Não converter a designação queen em medida acabada nem manter automaticamente a cama de casal ilustrativa da imagem como especificação. Esta resposta sobre móveis não cancela o inventário anterior de aparelhos, utensílios e PC já existentes.

#### JAN-027 — Estudo em escala do jantar e interface com entrada
**EM ESTUDO** · Fontes: F27; programa F25/F26.

A04.6 R01 testa banco reto de 180 × 55 cm, mesa fixa de 180 × 75 cm e três cadeiras sem braços. São dimensões propostas, não aprovadas por Elias. Frente nominal de 60 cm por pessoa; faixa residual conservadora de 65 cm atrás das cadeiras no envelope ocupado adotado, 85 cm com cadeiras recolhidas. Comprimentos e profundidades de sofá/chaise também são apenas envelopes de teste.

**Limite:** Os 515 cm documentais incluem o trecho até a parede da cozinha; não são comprimento exclusivo de sala/jantar. O recuo gráfico do banheiro não foi creditado como ganho de circulação. A reserva IB6 no extremo junto à entrada conflita com o giro gráfico da porta no cenário testado; resolver essa interface antes de aprovar layout completo e acesso inferior ao banco. Não foram alterados equipamentos, posições fechadas ou infraestrutura. Terceira cadeira, pedestal, conforto prolongado, janela/cortina e medidas acabadas continuam pendentes.

**Documentação:** [Pranchas em PDF](Sala_e_jantar/Layout_do_jantar_R01.pdf) e [memória de cálculo e hipóteses](Sala_e_jantar/Layout_do_jantar_R01.md). PDF A3: página 2 em 1:25; página 4 em 1:15 e página 5 em 1:10, impressão a 100%. Não usar para fabricação.

#### COZ-029 — Estudo em escala da cozinha
**EM ESTUDO** · Fontes: F30; distribuição A04.4 R01 e escolhas vigentes.

Auditoria local confirmou que A04.4 R00 tinha blocos e elevação sem escala, além de seções de reservas. A04.4 Implantação R01 atualiza essa base com planta e elevação em 1:20 no A3 a 100%, reserva IB6 de 80,1 cm e pedra a 92 cm provisórios. Metas de módulos somam 340,1 cm nos 352 documentais, deixando 11,9 antes de ajustes; a entrada continua em conflito.

**Limite:** Com hipótese de 85 cm preservados junto à entrada, restam 267 na linha; descontar IB6 80,1, cocção 65 e pia 75 deixa 46,9 para preparo e air fryer. Cenário diagnóstico, não redução aprovada. Altura do conjunto forno/cooktop a validar: 92 - 61 - 20 = 11 cm para elevação da base do forno e distância do topo da pedra ao fundo do cooktop. Nichos, aberturas, conexões, apoios e aéreo continuam pendentes. Estudo não aprova implantação final nem altera a IB6 oficial.

**Documentação:** [Pranchas vigentes da cozinha](Cozinha/Layout_da_cozinha_R01.pdf) e [memória do estudo](Cozinha/Layout_da_cozinha_R01.md). A04.4 R00 preservado como histórico.

#### DIM-001 — Pé-direito de referência informado
**EM ESTUDO** · Fontes: F22.

Elias encontrou referência média de 2,40–2,55 m para seu contexto Cury/Minha Casa Minha Vida. Registrar como faixa informada pelo usuário, não medição ou cota oficial desta unidade.

**Limite:** Não foi comprovada regra universal dessa construtora/programa. Altura local sob rebaixos e instalações pode diferir. Testar cenários, sem fixar altura de aéreos, testeira ou varal por essa faixa. Maior pé-direito não cria largura para volumes inferiores.

## 4. Respostas preservadas — canto alemão

A pergunta está resumida para consulta; a resposta mantém o conteúdo digitado. A leitura registrada não deve ampliar o significado de uma alternativa genérica.

### Rodada 1

| Pergunta | Resposta literal | Leitura registrada | Registros |
|---|---|---|---|
| 1. A medida 1,50 × 1,20 m indicada na planta é real? | c | É apenas uma estimativa/render. | JAN-023 |
| 2. Quantas pessoas usarão a mesa normalmente? | d | Escolheu a opção “Quero acomodar 5–6 ocasionalmente”; o número habitual não foi informado. | JAN-002, JAN-003 |
| 3. Quando houver visitas, qual prioridade? | b | Aceitar circulação mais apertada só durante visitas. | JAN-002 |
| 4. O canto precisa ser em L? | c | Escolher o que deixar a circulação melhor. | JAN-005 |
| 5. Usos além das refeições? | e | Vários dos usos apresentados; combinação exata não especificada. | JAN-004 |
| 6. Linguagem do banco? | b | Mais confortável: banco e encosto bastante estofados. | JAN-007 |
| 7. Integração direta com a marcenaria da cozinha? | d | Comparar visualmente três opções: Arenza; tonalidade semelhante; móvel independente. | JAN-011, JAN-012 |
| 8. Estofamento do encosto? | a | Encosto fixo estofado integrado. | JAN-008 |
| 9. Facilidade de limpeza/capas? | b | Basta tecido de alta resistência e fácil limpeza. | JAN-009 |
| 10. Conteúdo guardado no banco? | a b c | Jogos de tabuleiro; equipamentos/acessórios de ciclismo; mochilas/malas. | JAN-018 |
| 11. Acesso ao armazenamento? | d | Maximizar volume e delegar escolha da solução. | JAN-019, JAN-020 |
| 12. Aceita levantar/remover almofada? | a | Sim, sem problema. | JAN-019 |
| 13. Formato da mesa? | e | Priorizar circulação e delegar escolha. | JAN-015 |
| 14. Pedestal central? | a | Sim. | JAN-014 |
| 15. Aparência da mesa? | b | Tampo de madeira + base preta/grafite. | JAN-013, JAN-014 |
| 16. Base do banco? | a | Base fechada até o piso. | JAN-010 |
| 17. Duas cadeiras soltas? | d | Escolher a configuração que deixe a circulação melhor. | JAN-016 |
| 18. Cadeiras totalmente sob o tampo fora de uso? | a | Sim, isso é importante. | JAN-016 |
| 19. Recursos integrados? | e | Prever infraestrutura e decidir depois. | JAN-022 |
| 20. Ordem de prioridades? | circulação > número de lugares > armazenamento | Essa é a hierarquia própria informada por Elias. | JAN-001 |

### Rodada 2

| Pergunta | Resposta literal | Leitura registrada | Registros |
|---|---|---|---|
| 1. Encosto visual? | b | Dois ou três painéis estofados separados. | JAN-008 |
| 2. Aceita cadeira extra trazida só nas visitas? | s | Interpretado como sim, conforme o contexto da pergunta. | JAN-017 |
| 3. Tamanhos de caixas de jogos? | c | Muitas caixas de tamanhos diferentes. | JAN-018 |
| 4. Quais equipamentos de bike? | capacetes,mocinhas e laternas | Capacetes e lanternas; “mocinhas” foi interpretado antes como mochilas, sem confirmação literal do termo. Mochilas/malas já constam na rodada 1. | JAN-018 |
| 5. Aparência da mesa? | a | Leve e contemporânea, com tampo mais fino visualmente. | JAN-013 |
| 6. Cantos arredondados? | a | Sim, bastante arredondados. | JAN-013 |
| 7. Altura visual do encosto? | b | Média, equilibrada. | JAN-008 |
| 8. Parede sobre o banco? | d | Combinação discreta de arte + luz. | JAN-021 |

### Rodada da lavanderia — respostas literais F18

| Pergunta | Resposta literal | Escolha registrada |
|---|---|---|
| 1. Maior peça no varal | A | Cobertor leve de casal. |
| 2. Alcance do varal | A | Puxar para fora e baixar até altura confortável. |
| 3. Alternativa se acima do aquecedor não for viável | a | Varal oculto em módulo aéreo vizinho. |
| 4. Uso do tanque | b | Peças pequenas, panos, tênis e acessórios de ciclismo. |
| 5. Cesto | a | Um cesto único removível. |
| 6. Recicláveis | a | Recipiente removível escondido em módulo próprio. |
| 7. Itens de limpeza | b | Produtos, panos, ferramentas pequenas, vassoura, rodo e mop. |
| 8. Estoque | a | Produto em uso e uma reposição. |
| 9. Bancada | b | Apoio rápido para cesto e produtos. |
| 10. Aparência | a | Produtos e acessórios escondidos; frente da máquina aparente. |

Antes das respostas, Elias pediu aquecedor escondido por armário ripado e compartimento tipo gaveta acima dele com varal resistente para cobertores. Informou uso principal da lava e seca e ocasional do varal. A escolha 1A especifica o maior item como cobertor leve de casal, sem definir peso ou medidas. As respostas não aprovam mecanismo, fornecedor, carga nominal ou dimensões executivas.

### Rodada complementar da lavanderia — F21

Escolhas anteriores nesta sequência: **B** para varal oculto atrás de testeira; **A** para manivela com redução e trava.

| Pergunta | Resposta literal | Decisão |
|---|---|---|
| 1. Capacidade | 1A | Manter meta de 30 kg molhados. |
| 2. Manivela guardada | 2a | Removível, em suporte dentro do armário. |
| 3. Testeira | 3b para entender que acabou a cozinha e agr é lavanderia | Greenplac Arenza para marcar transição entre ambientes. |
| 4. Itens longos de limpeza | 4A | Compartimento estreito com porta própria. |
| 5. Recicláveis | 5a | Retirar recipiente pela alça após abrir a porta. |
| 6. Armário ripado | 6a | Porta de abrir com possibilidade de remoção técnica. |
| 7. Investimento | 7b | Equilíbrio de custo e resultado; acabamento sob medida admitido. |

## 5. Cuidados com o histórico e com as imagens

1. Escolha confirmada não é compra, aprovação técnica ou liberação para fabricação.
2. Os 79 IDs da v0.1 foram preservados; alterações de estado estão conciliadas com fontes específicas. As 28 respostas literais do canto alemão permanecem intactas.
3. A planta ilustrativa não substitui P01. Dimensões de móveis em imagens não foram promovidas a especificações. Cores renderizadas não são amostras reais.
4. Preservar quarto sem azul, retirada da pedra junto ao banheiro e ordem da cozinha. Não reinserir soluções de imagens superadas.
5. Base do banco até o piso, encosto fixo e cadeira extra continuam decisões; acabamento exato e capacidade física seguem pendentes.
6. Marcas visíveis em imagens, em especial Rinnai, não aprovam equipamentos. Modelos confirmados provêm das decisões documentadas.
7. A04.4 contém histórico cumulativo: confirmações finais prevalecem sobre parágrafos antigos de pesquisa. A recomendação de forno sob preparo foi substituída pelo pedido de forno sob cooktop.
8. As pranchas preliminares existentes não incorporam necessariamente todas as decisões recentes. Atualizá-las antes de usá-las como representação vigente.
9. O histórico de preços permanece datado. A v0.4 acrescenta pesquisa de produtos e manuais para o varal/aquecedor; não atualiza preços nem valida a instalação.
10. Função de pontos, material de paredes, regras de furação e relatos nos HTMLs da unidade filmada não são instruções de execução para o apartamento de Elias.

## 6. Fontes consultadas nesta consolidação

Citações internas apontam para os códigos abaixo. Os documentos e as imagens continuam sendo fontes distintas. Arquivos de imagem não são plantas técnicas ou comprovação de instalação.

### F01 — Texto colado.txt — PROJETO DO MEU APARTAMENTO — ELIAS
Tipo: `briefing_do_usuario`.
Arquivo de origem: `Texto colado.txt`.
Briefing integral disponibilizado na conversa. Referências por seção. O PDF mencionado nele não foi disponibilizado como PDF legível nesta consolidação.

### F02 — Canto alemão — questionário de 20 perguntas
Tipo: `respostas_do_usuario`.
Respostas 1 c até 20 circulação > número de lugares > armazenamento. Transcrição no anexo de respostas.

### F03 — Canto alemão — questionário complementar de 8 perguntas
Tipo: `respostas_do_usuario`.
Respostas 1b até 8d. Transcrição no anexo de respostas.

### F04 — Pedido de planta ilustrativa com mudança do canto alemão
Tipo: `pedido_do_usuario`.
Solicitação de representar a proposta de banco reto; não fornece medidas nem aprovação executiva.

> Gere a imagem ilustrativa da planta baseado em todas as decisões tomadas ate aqui com visao de cima com essa mudança do canto alemão

### F05 — Correções da planta: ordem da cozinha e retirada da pedra
Tipo: `correcao_do_usuario`.

> Nao precisa detalhar o móvel azul do teto nessa imagem pois é uma planta visão de cima

> ao abrir a porta de entrada o primeiro item é a geladeira, dps pia, dps fogão, dps máquina de lavar dps tanque

> Remova essa pedra que encosta na parede do banheiro quero só o chão do apartamento aqui, deixando a circulação da cozinha mais livre

### F06 — Gavetas sob a air fryer, duas portas sob a pia e ripado
Tipo: `pedido_do_usuario`.
Pedido também menciona madeira ripada na área do aquecedor; a permanência do equipamento foi esclarecida em F07.

> Na mesma altura da air fryer só que abaixo dela mova as gavetas que estão abaixo do filtro de água para lá e abaixo da pia coloque 2 portas ao invés de gavetas

### F07 — Manter aquecedor; ajustar disposição inferior
Tipo: `correcao_do_usuario`.
Não define marca/modelo do aquecedor, número de gavetas, ferragens nem um padrão nacional comprovado.

> Coloque de volta o aquecedor a gás o ripado fica para guardar o aquecedor

> Essa parte de gavetas e armário de baixo ajuste seguindo o padrão mais utilizado no Brasil, ou veja se meu projeto fala sobre isso Se não tiver nd acate o que mais se vê no país

### F08 — Proposta 01 e recomendações anteriores
Tipo: `propostas_do_assistente`.
Banco reto, tampas independentes, ferragem assistida, divisórias ajustáveis, Arenza no banco e tecido greige/bege são propostas. Usar apenas quando compatíveis com as escolhas expressas; não presumir aprovação de cada detalhe.

### I01 — Planta fornecida pelo usuário
Tipo: `referencia_visual`.
Arquivo de origem: `295633.png`.
Referência de implantação. As cotas não foram validadas para execução. A medida 1,50 × 1,20 m do canto alemão foi expressamente classificada como estimativa/render.

### I02 — Cozinha/lavanderia fornecida pelo usuário
Tipo: `referencia_visual`.
Arquivo de origem: `295686.jpg`.
Referência de composição e aparência; marcas aparentes e proporções não definem compras ou dimensões.

### I03 — Planta após correção da ordem e retirada da pedra
Tipo: `imagem_gerada`.
Arquivo de origem: `planta_3d_de_apartamento_moderno_rotulado.png`.
Estudo ilustrativo. A legenda dimensional do canto alemão continua sem validade executiva.

### I04 — Cozinha com aquecedor reinserido e ripado
Tipo: `imagem_gerada`.
Arquivo de origem: `cozinha_azul_com_aquecedor_rinnai.png`.
Estudo ilustrativo. Rinnai no nome/na imagem não é marca aprovada. Ripado, duto, conexões e afastamentos não foram tecnicamente validados.

### Fontes adicionais da conciliação 0.2

Os relatos de decisões nos documentos abaixo foram incorporados com sua origem, sem alegar recuperação de conversas externas completas. Os códigos F01–F08/I01–I04 acima preservam a proveniência histórica da v0.1; menções a PDF não lido descrevem aquela consolidação, não esta revisão.

- **F09:** [Memorial v2, 08/09/2026](../02_Plantas_e_manuais/Memorial_do_apartamento_v2.pdf), seis páginas; leitura integral realizada nesta conversa e consulta visual ao moodboard.
- **F10:** [Planta baixa oficial P01](../02_Plantas_e_manuais/Planta_oficial.pdf); orientação e cotas documentais.
- **F11:** [HTML R01](../04_Visita_ao_apartamento/Relatorio_da_visita_R01.html) e [HTML adicional R02](../04_Visita_ao_apartamento/Complemento/Complemento_da_visita_R02.html), com R00 como histórico; [base A01.2](Medidas/Origem_das_medidas_R00.md). HTMLs consultados como documentação de evidências; não foi realizada nova vistoria nem reprodução integral do vídeo.
- **F12:** [A04.2 R01: partido da lavanderia](Lavanderia/Decisoes_da_lavanderia_R01.md), R00 como histórico do retorno em L e simultaneidade.
- **F13:** [A04.3 R01: escolha VC4 e orçamento](Equipamentos/LG_VC4_escolha_e_pendencias_R01.md).
- **F14:** [A04.4: conferência e continuidade](Cozinha/Equipamentos_e_instalacao_R00.md), incluindo confirmações cumulativas de equipamentos e hábitos; [quadro dimensional](Cozinha/Medidas_e_folgas_R00.md).
- **F15:** [Distribuição de cozinha R01](Cozinha/Ordem_dos_moveis_R01.md), correção da posição do forno e organização interna.
- **F16:** Instruções de Elias nesta conversa: briefing integral, intenção de receber 5–6 amigos, escritório/home office/gaming/ciclismo, atmosfera de casa moderna organizada e pedido de conciliar o registro; esclarecimento de que só dispõe da planta oficial e HTMLs como base dimensional. Pergunta sobre rotina de secagem estava sem resposta na v0.2; encerrada por F18.
- **F17:** [Registro mestre v0.1 preservado](../99_Arquivo/Registros_anteriores/Registro_v0.1.md), origem dos 79 IDs e das 28 respostas de canto alemão.

- **F18:** Mensagens de Elias nesta conversa após a v0.2: armário ripado para esconder aquecedor, compartimento tipo gaveta com varal acima, uso principal da lava e seca e ocasional do varal; dez respostas literais preservadas na seção 4. A aprovação funcional não preenche dimensões ou validação técnica.

- **F19:** Pedido de Elias nesta conversa para estudar fixação/carga maior e compatibilização com aquecedor. Resultado em [A04.5 — Varal, carga e aquecedor](Lavanderia/Varal_e_aquecedor_R00.md). Consulta atual a fontes primárias de Rinnai, Knauf, Mad Varais e Foxydry em 10/09/2026, com links no estudo. Meta numérica e geometria são propostas, não novas aprovações do usuário.

- **F20:** Elias considera suspensão do varal pelo teto e informa limite de profundidade de furação de 3 cm na parede do aquecedor. Atualização do estudo: estrutura independente pelo teto em avaliação; não constitui autorização de furação ou aprovação de cabimento.

- **F21:** Respostas atuais de Elias: B (testeira), A (manivela), 1A/2a/3b/4A/5a/6a/7b e justificativa do Arenza como transição cozinha/lavanderia. Também solicitou um único registro por dia, sobrescrito ao longo do dia.

- **F22:** Elias questiona cabimento de compartimento de vassouras, recicláveis e cesto; informa faixa de pé-direito de 2,40–2,55 m como referência e solicita gaveta horizontal fina e longa na base da cozinha, preservando espaço para os pés na pia. Cabimento não confirmado.

- **F23:** Elias aprova provisoriamente a altura de 92 cm para o topo da pedra e solicita registrar que ela poderá mudar após a medição da altura do cotovelo; informa estar sem trena no momento.

- **F24:** Rodada de rotina de cozinha e visitas. Respostas literais: 1b; 2a; 3a; 4a; 5a; 6 “compras quinzenais sempre mantendo 1-2 itens de estoque enquanto há um aberto”; 7b; 8a. Inventário: “tenho todos os aparelhos e utensilios q vc disse menos formas grandes e panelas gigantes”. Perguntas: Q1 moradores; Q2 comer à mesa simultaneamente com 5–6 amigos além de Elias; Q3 rotina de refeições; Q4 cozinheiros simultâneos; Q5 prioridade de bancada; Q6 compras; Q7 conjuntos de louças; Q8 escorredor. Traduções das escolhas em JAN-002/003 e COZ-017/021/023/027/028. Não inferir presença do segundo morador em todos os encontros.

- **F25:** Correção literal de Elias: “nao, 5 amigos + eu sendo 6 pessoas no maximo seu canto alemão com 3 lugares + 3 cadeiras”. Prevalece sobre interpretações anteriores de F16/F24: máximo de seis pessoas à mesa, três no banco e três em cadeiras; cabimento ainda sujeito ao layout.

- **F26:** Rodada para encaixe do layout. Respostas: 1b (duas cadeiras à mesa, terceira em outro ambiente); 2a (deslocar mesa nas visitas); 3c (extensível apenas se fixa não funcionar); 4b (servir comida na bancada); 5b (duas horas ou mais à mesa); 6a (aceita levantar para outro sair do banco); 7b (três pessoas alinhadas no mesmo trecho); 8a (cadeiras sem braços); 9a (reposicionar chaise com lugar definido); 10a (priorizar reorganização nas visitas). Inventário literal: “nao possuo nd, tudo será comprado novo, só tenho cama queen e tv 43pol”. Resposta interpretada no contexto de móveis desta rodada, preservando os aparelhos e utensílios previamente declarados existentes.

- **F27:** Pedido de Elias para estudo de escala, medidas e layout. A04.6 R00: leitura visual da planta oficial, comparação de cinco tampos, plantas esquemáticas de cotidiano e seis lugares, memória de hipóteses e interferência da reserva IB6 com entrada. Estudo produzido em 10/09/2026; nenhuma dimensão proposta se torna aprovação por constar na prancha.

- **F28:** Em 11/09/2026, Elias reafirma mesa com cantos arredondados para leveza visual e pede revisão da geladeira visando menos largura e mais bancada, com foco no freezer. Respostas: orçamento máximo R$ 3.600; freezer em cima/embaixo “tanto faz”; conteúdo “carnes, marmitas, sorvete, paes”. Escolha IB6 reaberta, sem substituta aprovada. Comparação inicial em A04.6_Revisao_geladeira_R00.md. As quinas retas usadas como envelopes gráficos no primeiro estudo não substituem JAN-013.

- **F29:** Elias mantém a IB6 como modelo oficial, pede correção da medida no layout e avaliação do arredondamento da mesa para seis lugares. A04.6 R01 corrige a reserva para 80,1 cm e desenha cantos R10 cm como recomendação ainda em estudo; sem aprovar raio, dimensões de fabricação ou resolução da entrada.

- **F30:** Elias pede verificar documentos antes de iniciar estudo de escala da cozinha. Auditoria e A04.4 Implantação R01 produzidas em 11/09/2026, aproveitando a base existente e distinguindo soma de módulos de implantação viável.

- **F31:** Elias aceita estudar revisão da zona da pia com tábua sobre parte da cuba; respostas 1a/2a/3c/4a/5a/6a/7a/8b/9c. Na sequência fixa “1500, focando em qualidade e custo beneficio” para cuba + torneira extensível + tábua. Perfil confirmado em COZ-024; modelos e cabimento ainda pendentes.

- **F32:** Continuidade solicitada por Elias e pesquisa de produtos em 11/09/2026. Comparação preliminar em A04.4_Selecao_cuba_torneira_tabua_R00.md; propostas e preços não equivalem a aprovação. Perfil e orçamento de COZ-024 permanecem confirmados.

- **F33:** Elias confirma em 11/09/2026: “ok, deixe dora como definida”, após esclarecer que se refere ao cesto da air fryer e aceitar manter sua conferência dimensional pendente. Cuba Dora 40 BL R6 94017/113 passa a definida; não aprova novo modelo de torneira, tábua, largura de módulo ou compra.

- **F34:** Elias pede escolher a torneira. Comparação acrescentada ao estudo A04.4_Selecao_cuba_torneira_tabua_R00.md: Araguari preta como indicação preliminar, Jutaí preta como alternativa; diferenças, limitações das fichas e orçamento indicativo registrados. Nenhuma torneira aprovada nesta etapa.

- **F35:** Elias rejeita as molas aparentes da Araguari e confirma preferência por torneira extensível de aparência discreta, sem essas molas. Busca passa a priorizar mangueira recolhida na bica. Apurema preta entra como candidata para avaliação, sem aprovação estética ou técnica. Araguari sai da seleção.

- **F36:** Elias confirma a Pingoo Apurema após pedir torneira extensível discreta sem molas aparentes. Pingoo Apurema preta passa a definida. Preservados jato único e orçamento total de R$ 1.500; preço, pressão, instalação e reparos ainda a conferir. Konnen Cartney não foi escolhida.

- **F37:** Elias responde 1A/2A/3A/4A à rodada da tábua: madeira própria para alimentos; aproximadamente metade da abertura; frutas, legumes, pães e montagem, carnes cruas em outra tábua; posicionamento à esquerda ou direita se os apoios permitirem estabilidade. Guarda vertical após secagem já confirmada. Sem dimensões de fabricação ou fornecedor aprovado.

- **F38:** Elias solicita testar o layout. [A04.4 Teste da pia R02](Cozinha/Layout_da_pia_R02.md) e PDF associado: pia60 com PE11X suspenso como proposta; pia e PE11X lado a lado excedem60. Ganho de15 na faixa compartilhada, de46,9 para61,9; não significa bancada livre durante operação da air fryer. Porta hipotética de85 deixa de interceptar corpo IB6 nesta distribuição; circulação, marcenaria interna, suspensão, escorredor e demais instalações não validados. Nenhuma nova aprovação de posição ou medidas executivas.

- **F39:** Elias pede altura do purificador suspenso e sugere posição lateral alinhada à parede; orientação aguarda esclarecimento. Proposta técnica não aprovada: base125 cm, vão33 sobre pedra92, topo158, reserva superior até180. Manual oficial consultado e limitações acrescidas ao estudo R02: 5 cm laterais, 15 atrás e22 acima na seção de apoio sobre superfície; fixação traseira em parede deve ser conciliada com ventilação. Giro90 não libera apoio pela lateral nem ganho automático de espaço.

- **F40:** Elias esclarece preferência pelo PE11X girado90 graus no plano, saída de água voltada para o lado. Manter aparelho vertical e nivelado; orientação funcional confirmada, apoio e localização exata não validados. Lateral com afastamento mínimo5 cm conforme manual; fixação traseira original não permite prender pela lateral. Estudar apoio independente e ventilação. Base125 cm permanece proposta, não aprovada.

- **F41:** Teste solicitado do PE11X girado90: [estudo lateral R03](Cozinha/Purificador_lateral_R03.md) e PDF com planta/elevação. Candidato à direita da cuba, saída à esquerda, base125 como hipótese e torneira deslocada. Corpos separados, mas acesso, lavagem, escorredor, suporte e afastamento térmico não validados. Aéreo local somente acima180 na hipótese. Não constitui aprovação de altura ou posição executiva.

- **F42:** Rodada de uso da pia e integração do purificador. Respostas literais de Elias: 1b, 2a, 3a, 4a, 6a. Confirmado: (1B) quem for pegar água pode esperar ou pedir passagem enquanto outra pessoa lava louça; não exigir uso simultâneo independente. (2A) apoio do purificador em prateleira visualmente fina em Greenplac Arenza, com estrutura e espessura a dimensionar. (3A) abertura local no aéreo sobre o purificador, preservando ventilação e acesso de manutenção; não nicho apertado. (4A) escorredor removível, guardado após secagem da louça, com local de guarda ainda a definir. (6A) se posição lateral prejudicar lavagem ou ficar próxima demais do calor, priorizar conforto e estudar outro ponto para o mesmo PE11X. Pergunta5 inicialmente omitida, depois respondida 5A e encerrada por F43. Base125 e encaixe técnico continuam em estudo.

- **F43:** Elias complementa a rodada F42 com 5A: aceita alternar tábua e escorredor, retirando o escorredor para usar a tábua. Não exigir uso simultâneo. Pendência da pergunta5 encerrada; guarda do escorredor e encaixes ainda a detalhar.

- **F44:** Rodada do escritório: respostas 1a/2b/3a/4a/5b/6c/7a/8a/9a/10c/11a; prioridade12: conforto na estação > receber hóspedes > armazenamento. Programa incorporado em ESC-003 e posição do PC em ESC-002. TV permanece para decisão após layout; duas vagas de hóspedes não aprovam modelo ou tamanho de cama. Sem medidas ou orçamento novos.

- **F45:** Elias responde à rodada de hóspedes do escritório: 1b/2a/3a/4a/5c/6a. Hospedagem aproximadamente mensal, uma ou duas noites; duas pessoas podem compartilhar uma cama. Aceita interromper a estação com cama aberta, mover cadeira e guardar volante/pedais em lugares previstos. Comparar sofá-cama e cama retrátil de parede no layout; nenhuma tipologia, dimensão, modelo ou orçamento aprovado. Prioridade F44 preservada.

- **F46:** Elias solicita o teste de encaixe do escritório. Produzido estudo A05.1 R00 em três páginas e memória explicativa, comparando sofá-cama e retrátil horizontal com bancada lateral. As medidas de móveis são hipóteses em estudo; nenhuma tipologia ou modelo escolhido. Preservadas decisões F44/F45. Interferência do sofá testado, acesso pelos pés na retrátil, guarda da cadeira e compatibilidade do mecanismo explicitados em ESC-003.
- **F47:** Elias determina: estação de trabalho de frente para a janela. Orientação confirmada em ESC-003; estudo R01 substitui a implantação lateral do R00. Dimensões de bancada e reserva para hóspedes continuam em estudo, sem modelo aprovado.
- **F48:** Elias pede exercício de três portas novas de correr: banheiro e escritório pelo lado externo; dormitório principal pelo lado interno, sem reaproveitar folhas. [Estudo de percurso e custo](../99_Arquivo/Estudos_anteriores/Portas_e_quarto/Portas_sem_recuo_R00.md). Leitura de P01 indica interrupções por paredes perpendiculares/quinas nos percursos propostos; três folhas rígidas convencionais com trilhos retos e vãos mantidos não passam no teste gráfico preliminar. Reserva estimada de R$ 5.000-9.000 para substituição simples das três, apenas se houver configuração viável, sem cotação ou aprovação de obra. Reforma estrutural/sistemas especiais fora da estimativa. Portas e orçamento permanecem em estudo; orientação da estação de frente para a janela preservada.
- **F49:** Elias esclarece: banheiro e escritório correriam pelo lado externo rumo ao dormitório, com o fechamento do dormitório recuado até perto do guarda-roupa. Solicita planta anotada e teste condicional de porta articulada onde houver ganho real. [Estudo corrigido R01](../99_Arquivo/Estudos_anteriores/Portas_e_quarto/Portas_com_recuo_R01.md) e PDF de três páginas. A reprovação F48 era restrita aos vãos mantidos; não se aplica integralmente ao recuo. Corrigida a leitura excessivamente categórica de paredes impeditivas: encontros da entrada antiga podem incluir batente, acabamento ou alvenaria e precisam de levantamento. Recuo pode permitir estudar duas folhas em faces opostas da circulação prolongada, condicionado a ressaltos, passagem útil, puxadores e novo fechamento junto ao armário. Porta articulada: banheiro é primeiro candidato por uso cotidiano; escritório só por conflito demonstrado com cama/circulação; dormitório tem menor ganho comprovado no vão atual. Nenhuma troca, recuo, modelo, dimensão ou obra aprovada. F48 não orça adequações do novo fechamento. Estação de frente para a janela preservada.
- **F50:** Elias manifesta gostar da proposta F49 de recuar o fechamento do dormitório e pergunta se a porta desse dormitório pode ser mantida. Direção de estudo aceita; tipo de porta, recuo e viabilidade executiva permanecem pendentes. Manter porta de giro é alternativa a testar antes de substituí-la: o giro para dentro pode atingir a extremidade/frente do guarda-roupa, conforme referência visual, e a cama queen deve ser considerada. Não garantir cabimento invertendo dobradiças sem verificar toda a trajetória. Pode exigir menor recuo ou ajuste da extremidade da marcenaria, sem aprovação automática dessas alterações. Reaproveitamento físico da folha e batente é questão separada, dependente de dimensões, estado e desmontagem; não foi confirmado. Não aprovada porta articulada, nova compra ou alteração estrutural.
- **F51:** Elias solicita teste do impacto no dormitório das duas portas de correr externas com recuo do batente e estabelece **teto total confirmado de R$ 10.000** para todo o movimento (portas, mão de obra, recuo/novo fechamento e adequações), preferindo execução pela construtora se possível. [Estudo R02](Portas_e_quarto/Portas_e_impacto_no_quarto_R02.md) e PDF com recuo hipotético80 cm; giro convencional75 cm interfere com armário hipotético245 x55, exigindo redução geométrica aproximada29 cm. Articulada ideal de duas folhas37,5 não cruza esse armário; recomendação preliminar para preservar armazenamento, sem escolha de modelo/tipo aprovada. Cama representada por reserva200 x160, não medida da queen; estreitamentos40/45 cm impedem aprovar conforto do quarto. Folhas externas, novo batente e circulação dependem de cotas acabadas, ressaltos e sistemas reais. Verba proposta: R$ 8.500 em serviços/produtos + R$ 1.500 de reserva; não é cotação ou garantia de suficiência. Consulta à Cury preparada, não enviada; personalização e execução pela construtora não confirmadas. Não autorizada contratação, obra, corte estrutural ou gasto acima do teto.
- **F52:** Elias escolhe as tipologias para a solução de portas: **banheiro e escritório com portas de correr e trilho oculto; dormitório com porta camarão na entrada recuada**. Continuidade de F49/F51: folhas externas correndo rumo ao dormitório. Interpretação de projeto do trilho oculto: trilho superior encoberto por acabamento, mantendo folhas sobrepostas às faces externas; não implica portas embutidas em alvenaria. Intenção expressa de aumentar a sensação de amplitude. Tipologias e direção visual confirmadas; recuo80 cm, dimensões, ferragens, acabamento da cobertura do trilho, passagem útil e execução continuam em estudo. Teto global R$ 10.000 preservado. A combinação preferida do R02 passa a ser a direção escolhida, sem transformar o ensaio geométrico em aprovação técnica ou autorização de compra/obra. Avaliação pela construtora ainda pendente; não prometer aumento físico de área ou amplitude extraordinária antes de validar o conjunto.
## 7. Rotina de atualização

1. Consultar este registro antes de perguntar ou desenhar. Manter IDs estáveis e registrar fonte e data conhecida; não inventar data original.
2. Nova proposta permanece em estudo até confirmação. Cada resposta deve indicar o que mudou e o que continua pendente.
3. Manter um registro por dia e sobrescrever o vigente durante esse dia, conforme Elias. Preservar histórico das decisões no texto e arquivos anteriores já existentes; não gerar uma nova versão a cada resposta.
4. Atualizar este Markdown como registro vigente. Se houver futura base JSON/site, migrar explicitamente e definir sincronização; não presumir automação existente.
5. Distinguir cota documental, reserva de equipamento, meta de estudo e medida acabada. Deixar sem valor os dados indisponíveis.
6. Manter links para estudos e atualizar imagens afetadas após decisões. Publicação externa é uma etapa separada.

## 8. Histórico de versões

| Versão | Data | Alteração |
|---|---|---|
| 0.1 | 2026-09-10 | Consolidação original de 79 registros e 28 respostas, preservada em arquivo próprio. |
| 0.2 | 2026-09-10 | Conciliação com memorial, planta, HTMLs e estudos; equipamentos, hábitos, orçamento, infraestrutura, novas prioridades e limites dimensionais. IDs antigos e respostas preservados. |
| 0.3 | 2026-09-10 | Rodada de dez respostas da lavanderia; programa funcional atualizado, intenção de armário ripado confirmada, varal extraível com descida e alternativa lateral condicional; rotina de secagem encerrada. |
| 0.4 | 2026-09-10 | Estudo A04.5 de carga, fixação e aquecedor; meta proposta de 30 kg, geometria de estudo, fontes primárias e incompatibilidades identificadas sem liberar execução. |
| 0.5 | 2026-09-10 | Restrição de furação informada por Elias; alternativa de suporte pelo teto em estudo, sem aprovação de ancoragem ou posição sobre o aquecedor. |
| 0.6 | 2026-09-11 | Consolidação das decisões de cozinha, pia, purificador, jantar, escritório e portas até F52. Arquivo vigente renomeado para Registro_de_decisoes.md; conteúdo e IDs preservados. |

### Limites desta revisão

Conciliação de arquivos locais e instruções disponíveis nesta conversa; não é busca em todas as conversas de outras contas nem verificação do GitHub/Drive. Na v0.4 houve pesquisa técnica e memória preliminar de esforços, sem medição/vistoria, dimensionamento executivo, cotação final, compra ou alteração de escolhas fechadas. A integração futura com site ainda não foi realizada.
...
#### Purificador Electrolux PE12G definido

Elias confirma em 15/09/2026: “PE12G DEFINIDO ENTÃO”. O **Electrolux PE12G grafite** passa de candidato a modelo escolhido do projeto, substituindo o PE11X e encerrando a comparação de purificadores. Permanecem as funções de água natural, fria e gelada, corpo de referência de 16 × 42 × 35 cm e reserva preliminar de 26 × 52 × 57 cm já documentados. O teto de pesquisa fica em aproximadamente R$ 660.

A escolha do modelo não constitui compra nem libera instalação ou fabricação. Alimentação de água, pressão, tomada, proximidade da air fryer e de outras fontes de calor, respingos, acesso ao refil/manutenção e posição final sobre a bancada junto à geladeira ainda precisam de compatibilização. Documentação local atualizada; site e fontes geradoras preservados até autorização expressa de Elias.

#### Espelho de corpo inteiro na lateral do guarda-roupa definido

Elias confirma “definido” à proposta para o dormitório. Adotar **espelho Cebrace prata de 5 mm, 50 × 180 cm**, sem moldura e sem bisotê, com bordas lapidadas e cantos levemente arredondados. Posição: centralizado na lateral de 60 cm do guarda-roupa, com margens nominais de 5 cm e base de referência a 20 cm do piso. A solução é de corpo inteiro e deve permanecer visualmente leve, coerente com o quarto sem azul nos móveis.

Antes da execução, medir a lateral pronta, confirmar sua planicidade e resistência, especificar fixador próprio para espelho e compatibilizar ventilação e proteção das bordas segundo o fabricante. A escolha não constitui compra nem instalação realizada. Site e fontes geradoras não foram alterados; atualização futura depende de autorização expressa de Elias.

#### Escorredor compacto definido

Elias escolhe a tipologia tradicional compacta e aprova o **Tramontina Mini Plurale Grafite, referência 61537000**. Dimensões oficiais: 27,8 × 19,9 × 12,6 cm; capacidade declarada para nove pratos, copos e talheres; porta-talheres removível, porta-copos expansível, pés de silicone e bandeja inclinada para conduzir a água à cuba. Esta escolha substitui definitivamente a esteira Mimo SN19070.

Manter a rotina já aprovada: usar junto à cuba, com a saída da bandeja direcionada para ela, deixar a louça cotidiana secar e guardar o escorredor limpo e seco no gabinete inferior. Não dimensionar para panelas e formas. O produto cabe verticalmente no vão inferior provisório de 22,2 cm, com sobra nominal de 9,6 cm, mas posição, manobra, sifão, demais utensílios e medidas acabadas ainda precisam de conferência. Compra não realizada. Site e fontes geradoras preservados até autorização expressa de Elias.

#### Lixeira de chão definida

Elias aprova a **Tramontina Loop 12 L com pedal, referência 94547012**. Especificações da referência consultada: 24,8 × 24,8 × 37,2 cm, corpo em aço inox AISI 430, tampa com fechamento suave, balde interno plástico removível, base antiderrapante e sistema stay-open. Sacos recomendados de 12 a 20 L. A escolha substitui o status anterior de modelo pendente e preserva a decisão de não ocupar o gabinete da pia com lixeira.

A posição exata no chão ainda será compatibilizada com circulação, pedal, abertura das portas e gavetas e trajeto de trabalho. Não houve compra. Site e fontes geradoras preservados até autorização expressa de Elias.

#### Panela de pressão compacta definida

Após manter inicialmente a Vancouver Effect 3 L como candidata, Elias confirma: “sim, será essa”. Fica escolhida a **panela de pressão Tramontina Vancouver Effect preta, 3 L, referência 20593420**. A ficha oficial informa 18,1 cm de altura, 23,1 cm de largura e 20 cm de diâmetro. Preservar a decisão de preparar 1 kg de feijão em mais de uma rodada, respeitando o limite de enchimento do produto.

No vão inferior provisório de 22,2 cm, a sobra vertical calculada é de 4,1 cm. Isso não comprova retirada confortável, comprimento com cabo, abertura da tampa nem compatibilidade com sifão, mangueira e demais utensílios; conferir antes de fixar a prateleira. O comprimento de 38,6 cm registrado na página comercial é da embalagem e não deve ser tratado como dimensão do produto. Compra não realizada. Site e fontes geradoras preservados até autorização expressa de Elias.

#### Posição inicial da prateleira regulável aprovada

Elias responde “podemos” à proposta de posicionar inicialmente o topo da prateleira regulável do gabinete da pia a aproximadamente 50 cm do piso. Nas premissas atuais, isso produz vão inferior útil de 26,2 cm e vão superior de 21,5 cm até o fundo estimado da cuba, antes de sifão, mangueira e espaço para a mão. A panela de pressão escolhida, com 18,1 cm de altura, recebe cerca de 8,1 cm de folga vertical.

A referência de 50 cm orienta o detalhamento, mas a prateleira permanece regulável e deve ser ajustada após medição das instalações e utensílios reais. Não transformar os vãos calculados em medidas acabadas nem declarar todo o conteúdo acomodado sem teste. Site e fontes geradoras preservados até autorização expressa de Elias.

#### Posição da lixeira aprovada pela planta

Elias envia recorte da planta e indica com círculo verde a posição desejada: **lixeira encostada na parede externa do banheiro, voltada para a mesa**. Esta posição substitui a proposta anterior ao lado da geladeira. Adotar a Tramontina Loop 12 L nesse ponto, com pedal voltado para o acesso e sem fixação ao piso ou à parede.

No modelo gráfico vigente, a face externa da parede do banheiro está aproximadamente 141 cm antes do início da mesa; descontando os 24,8 cm da lixeira, a passagem nominal fica em torno de 116 cm. O ponto também se mantém afastado do giro gráfico da porta do banheiro. São valores do desenho, não medição acabada: confirmar parede, rodapé, curso da tampa, acesso ao pedal e circulação real antes de consolidar a implantação executiva. Site e fontes geradoras preservados até autorização expressa de Elias.

#### Capacidade da lixeira comum corrigida e definida em 15 L

Elias determina: “só muda o tamanho da lixeira comum para 15L, e salve como definido”. A capacidade vigente da lixeira comum passa de 12 para **15 litros**, preservando a posição já aprovada na parede externa do banheiro, voltada para a mesa. A Tramontina Loop 12 L deixa de ser o modelo vigente, pois a linha Loop não possui versão de 15 L.

Adotar a **Biovis Coleta 15 L**, com corpo em aço inox escovado, pedal e balde interno removível. Dimensões declaradas pelo fabricante: 47 cm de altura, 21 cm de largura e 34 cm de profundidade; altura aberta de 72,5 cm. No desenho, os 34 cm de profundidade deixam passagem nominal de aproximadamente 107 cm até a mesa, antes da conferência em obra. Confirmar rodapé, abertura da tampa e acesso ao pedal. Fonte oficial consultada em 15/09/2026: https://novo.biovis.com.br/produto/lixeira-coleta-15l/.

A lixeira de recicláveis de 20 L desenhada na lavanderia continua como proposta separada, ainda sem aprovação definitiva. Documentação local atualizada; site, fontes geradoras e publicação preservados conforme orientação expressa de Elias.

#### Lixeira de recicláveis da lavanderia definida

Elias aprova a candidata apresentada e determina sua definição no projeto: **Tramontina Loop 20 L com pedal, referência 94547020**. Produto em aço inox AISI 430 com acabamento polido, fechamento suave, alça para transporte e balde interno plástico removível. Dimensões sem embalagem: 29 cm de largura × 29 cm de comprimento × 43,7 cm de altura; saco recomendado de 20 L, com compatibilidade indicada pelo fabricante entre 20 e 40 L.

Implantação aprovada: no chão da lavanderia, no ponto marcado em vermelho por Elias, fora do armário baixo. Esta decisão libera o vão sob o tanque para o cesto de roupas e instalações e substitui os ensaios anteriores em que cesto e recicláveis dividiam o gabinete. Antes da execução, conferir rodapé, curso da tampa, acesso ao pedal, retirada do balde e circulação. Fonte oficial consultada em 15/09/2026: https://www.tramontina.com.br/lixeira-com-pedal-tramontina-loop-em-aco-inox-com-acabamento-polido-e-balde-interno-20-l/94547020.html.

Compra não realizada. Documentação local atualizada; site, fontes geradoras e publicação preservados conforme orientação expressa de Elias.

## Banheiro — cuba e conforto de uso, 18/09/2026

**Confirmado por Elias nesta conversa:** referência visual “Imagem do Codex 7 de set. de 2026, 23_23_07.png”; cuba de apoio branca, retangular, semelhante à imagem. Altura do conjunto deve atender à sua estatura de 1,75 m, já informada em F15. Marca e modelo da cuba ainda não escolhidos.

**Proposta dimensional, ainda a validar:** borda superior da cuba a 90 cm do piso acabado como ponto de partida para teste de conforto. Altura do tampo = 90 cm menos a altura efetiva da cuba acima da pedra. Exemplo apenas: cuba com 12 cm acima do tampo implica tampo a 78 cm. Não usar automaticamente os 92 cm da bancada da cozinha. Conferir conforto com simulação e compatibilizar cuba, torneira, sifão e gabinete antes da fabricação. A estatura isolada não garante a altura ideal.

As demais sugestões de composição apresentadas nesta conversa permanecem propostas; esta confirmação não aprova automaticamente todo o banheiro.

### Seleção da cuba — continuação de 18/09/2026

Elias prioriza facilidade de limpeza, pouco acúmulo de sujeira, beleza e integração com o projeto. Recomendação apresentada: Deca Slim retangular branca sem mesa L.13040.17, nominal 40 × 30 × 13,5 cm. Modelo candidato, sem aprovação do usuário ou compra. A ficha de dimensões e a página oficial indicam formato de cantos suavizados; fabricante anuncia esmalte Protekto e retentor Smart Block. Isso não comprova ausência de acúmulo ou desempenho comparativo: retentor e tampa da válvula exigem limpeza. Prever acesso para limpeza ao redor/atrás e vedação conforme manual; largura/profundidade final da bancada ainda não conferidas.

Com borda proposta a 90 cm, altura nominal do tampo seria 76,5 cm, a confirmar pela altura efetivamente instalada da peça e teste de conforto; substitui apenas o exemplo anterior de cuba hipotética de 12 cm. A altura de 90 cm ainda não é executiva.

Fontes consultadas em 18/09/2026:
- https://www.deca.com.br/ambientes/banheiro-e-lavabo/cubas-para-banheiro/cuba-de-apoio/cuba-retangular-de-apoio-40-cm-branco-cubas-slim--l1304017 (conteúdo indexado; acesso direto retornou 403).
- https://produtos.deca.com.br/Deca/L.13040.17/fichaTecnica/ficha_tecnica_1714550630635_L.13040.17.pdf
- https://produtos.deca.com.br/Deca/L.13040.17/pdf/pecasdereposicao-l13040.pdf

Alternativa pesquisada: Celite QR3, código 1730750017300; não priorizada nesta rodada, pois página oficial tem divergência entre dimensões no cabeçalho e desenho técnico e indica indisponibilidade. Não inferir encaixe definitivo da Deca apenas pelas medidas gerais do banheiro.

### Cuba — primeira opção confirmada por Elias em 18/09/2026

Elias pediu: “ok, deixa essa como 1 opção”. Deca Slim retangular branca sem mesa, L.13040.17, nominal 40 × 30 × 13,5 cm, passa de candidata apresentada a **primeira opção de projeto**. Não equivale a compra ou aprovação para fabricação. Prioridades confirmadas: facilidade de limpeza, beleza, integração com a referência e sensação de banheiro amplo. Preservar leveza visual e espaço utilizável ao redor da cuba; verificar encaixe com bancada e torneira. Altura proposta da borda: 90 cm do piso acabado para Elias (1,75 m), ainda sujeita a teste de conforto; tampo nominal de 76,5 cm somente se a altura instalada da cuba for 13,5 cm. Demais sugestões de gabinete, espelho, nichos e box continuam em estudo.

### Lavatório — água quente e torneira preta confirmadas, 18/09/2026

Elias confirmou água quente na pia do banheiro e apoiou a torneira preta após proposta de acabamento preto fosco. Registrar como requisito funcional e acabamento escolhido. Infraestrutura de água quente do lavatório NÃO comprovada: memorial confirma previsão para chuveiro; conferir percurso permitido, pontos, pressão, vazão e compatibilidade do aquecimento antes de executar. Não implica autorização técnica de rasgos ou derivações.

Proposta do assistente: misturador monocomando de bancada, bica alta, com comando único de vazão e temperatura. Candidato inicial para avaliação visual: Deca Level Black Matte 2885.BL26.MT. Marca/modelo e mecanismo ainda não aprovados por Elias. Verificar alcance/altura do jato com a cuba Slim L.13040.17, espaço para limpeza, pressão exigida e funcionamento com aquecedor; orçamento da torneira ainda não informado.

Fonte de produto: https://www.deca.com.br/ambientes/banheiro-e-lavabo/torneiras-e-misturadores-para-banheiro/monocomando-para-cuba-e-lavatorio/misturador-monocomando-de-mesa-bica-alta-para-lavatorio-level-black-matte-2885bl26mt

### Misturador — orçamento informado em 18/09/2026

Elias informou R$ 750 para a torneira. Adotado como teto de seleção do misturador, sem presumir inclusão de instalação, frete ou infraestrutura de água quente.

Candidato dentro da referência de preço encontrada: Addra Arion Black, monocomando de mesa para banheiro, bica alta. Resultado indexado da loja oficial Addra no Mercado Livre exibia R$ 671,89 sem cupom (R$ 641,89 com cupom); preço de referência, não cotação final, estoque/frete/CEP não confirmados. Modelo do catálogo Addra; não confundir com Arion de cozinha ou bica baixa. Não aprovado pelo usuário. Pressão mínima, alcance e altura de saída, manutenção/peças e encaixe na Deca Slim ainda não verificados em ficha/manual, portanto não liberar compra nem afirmar compatibilidade hidráulica/dimensional. Deca Level fica sem prioridade de seleção até demonstrar oferta dentro do teto.

Fontes da pesquisa:
- https://www.mercadolivre.com.br/loja/addra?category_id=MLB1574&client=recoview-selleritems&item_id=MLB4600325671&official_store_id=303342&recos_listing=true
- https://www.addra.com.br/
- https://www.cassol.com.br/torneira-misturador-monocomando-para-banheiro-de-mesa-bica-alta-1x2polegadas-metal-arion-black-addra/p

### Misturador escolhido — Addra Arion Black, 18/09/2026

**CONFIRMADO por Elias:** “ok, confirmado essa”, referindo-se à Addra Arion Black, misturador monocomando de mesa para BANHEIRO, BICA ALTA, acabamento preto fosco, conexão nominal 1/2", apresentada na página Cassol abaixo. Passa de candidata a escolha de projeto; substitui a proposta Deca Level. Não confundir com versões de cozinha ou bica baixa.

Teto informado: R$ 750 para o misturador. Referência de preço anterior: R$ 671,89 sem cupom em resultado indexado da loja oficial Addra; não é preço final confirmado. Frete, estoque e preço no momento da compra pendentes. Compra não realizada.

Conjunto previsto: cuba Deca Slim branca L.13040.17 como primeira opção; água quente e fria na pia. Conferir manual/ficha do misturador, pressão, vazão, compatibilidade com aquecimento, altura e alcance da saída, furação e espaço de limpeza antes da execução. Infraestrutura quente do lavatório ainda não comprovada pelo memorial. Escolha estética e funcional aprovada; dimensionamento executivo ainda pendente.

Página identificadora: https://www.cassol.com.br/torneira-misturador-monocomando-para-banheiro-de-mesa-bica-alta-1x2polegadas-metal-arion-black-addra/p

### Bancada do banheiro — pedra confirmada em 18/09/2026

Elias solicitou: “quero q seja a mesma pedra da cozinha”. Confirmado **granito Branco Itaúnas**, conforme escolha vigente da cozinha (MAT-004). Aplica-se à bancada do lavatório do banheiro, substituindo a proposta genérica anterior de pedra bege a escolher. Não estender automaticamente a nicho, soleira, paredes ou piso; não altera os revestimentos já registrados. Acabamento superficial, seleção da chapa, espessura/borda e dimensões permanecem a detalhar. A escolha do mesmo material não transfere a altura de 92 cm proposta para a cozinha: no banheiro permanece a proposta de borda da cuba a 90 cm, com altura do tampo ajustada à cuba e teste de conforto.

Conjunto vigente: bancada Branco Itaúnas; cuba Deca Slim branca L.13040.17 como primeira opção; misturador Addra Arion Black de banheiro, bica alta, preto fosco, escolhido; água quente e fria desejadas, infraestrutura ainda a conferir.

### Gabinete do banheiro — fechamento confirmado, 18/09/2026

Elias escolheu “gabinete inteiro fechado” em resposta à alternativa de nicho aberto para toalhas. **Confirmado: gabinete inferior totalmente fechado, sem nichos abertos**, substituindo a proposta anterior de fechamento parcial com pequeno nicho. Organização interna, portas ou gavetas, materiais, cores, puxadores e dimensões permanecem a definir. Instalação suspensa continua como proposta para preservar piso aparente e sensação de amplitude; esta resposta não aprova automaticamente todos os detalhes da proposta anterior. Compatibilizar interior com cuba de apoio, sifão, engates quente/frio e acesso à manutenção.

### Gabinete suspenso confirmado — 18/09/2026

Elias respondeu “sim” à proposta de deixar o gabinete do banheiro suspenso, com o piso aparecendo embaixo. **Confirmado: gabinete inferior inteiro fechado, sem nichos abertos, suspenso.** Objetivo: visual organizado e sensação de amplitude. Distância do piso, dimensões, portas/gavetas, acabamento e fixações ainda a definir; compatibilizar sifão, conexões de água quente/fria e acesso à manutenção. Não inferir aprovação de cor ou organização interna.

### Acabamento do gabinete inferior confirmado — 18/09/2026

Elias concordou e definiu a proposta apresentada: **frentes bege foscas, lisas, sem ripado e sem puxadores salientes; madeira clara nas laterais**. Mantêm-se as decisões de gabinete suspenso, inteiramente fechado e sem nichos abertos. Intenção: proximidade com a referência, sensação de amplitude, integração com o granito Branco Itaúnas e facilidade de limpeza.

Marca/código do bege, padrão exato da madeira, material construtivo, mecanismo de abertura, portas/gavetas, dimensões e fixação permanecem a detalhar. Não adotar automaticamente Arenza nas laterais sem confirmação de padrão. A proposta de madeira mais presente no futuro armário do espelho orienta o estudo desse conjunto, sem definir sua composição ou aprovar nichos abertos.

### Armário superior espelhado — escolha confirmada em 18/09/2026

Elias escolheu “armazenamento raso atrás do espelho, para não ocupar muita profundidade”. **Confirmado: armário superior raso com armazenamento atrás do espelho**, priorizando pouca projeção sobre a bancada e sensação de amplitude. Profundidade numérica, largura, altura, portas/divisões, prateleiras, acabamento lateral e iluminação ainda a detalhar; não inferir aprovação automática de todos os elementos sugeridos anteriormente. Compatibilizar abertura e uso com a torneira Addra Arion de bica alta e a cuba Deca Slim, além de acesso confortável ao lavatório.

### Conteúdo do armário espelhado confirmado — 18/09/2026

Elias informou que pretende guardar **escovas, pasta de dentes, desodorante e pequenos cosméticos** no armário raso atrás do espelho. Usar esses itens como base do dimensionamento interno, preservando a prioridade de pouca profundidade. Conferir embalagens reais, incluindo posição de armazenamento das escovas, antes de fechar profundidade útil e vãos. Não há profundidade numérica aprovada nem necessidade informada de acomodar frascos grandes. Prateleiras reguláveis são proposta de organização, ainda sem detalhamento executivo.

### Composição do armário espelhado confirmada — 18/09/2026

Elias respondeu “sim” à proposta de **toda a frente espelhada, sem nichos abertos, e madeira clara apenas nas laterais**. Confirmado para o armário superior raso, destinado a escovas, pasta de dentes, desodorante e pequenos cosméticos. Preservar sensação de amplitude e integração com o gabinete inferior. Profundidade, largura, altura, quantidade de portas, ferragens, prateleiras e padrão exato da madeira permanecem a detalhar. Frente toda espelhada não implica uma única porta ou ausência de juntas. Prateleiras reguláveis continuam proposta, sem aprovação específica nesta resposta.

### Iluminação e imagem final — confirmadas em 18/09/2026

Elias aprovou a proposta de **luz quente e indireta, inspirada na referência, complementada por luz junto ao espelho para iluminar o rosto**. Temperatura de cor exata, luminárias, potência, posicionamento, proteção e instalação ainda a detalhar; não inferir aprovação específica de 3000 K nesta resposta.

Elias solicitou que, **ao final das decisões do banheiro**, seja gerada uma imagem realista para avaliar o resultado e decidir eventuais mudanças. Entrega futura autorizada dentro desta conversa: gerar após fechar as decisões, usando as escolhas vigentes e a geometria disponível, distinguindo medidas conhecidas de hipóteses. Não gerar agora nem tratar imagem como comprovação de encaixe executivo. Preservar as escolhas já aprovadas (cuba primeira opção Deca Slim, misturador Addra Arion Black, granito Branco Itaúnas, gabinete inferior suspenso fechado bege/madeira e armário superior raso todo espelhado).

### Verde nas paredes de todo o box — direção aceita, 18/09/2026

Após manifestar preferência estética pelo verde no box inteiro e perguntar sobre amplitude, Elias respondeu “ok, seguimos” à recomendação de seguir com verde sálvia nas paredes de todo o box e comparar visualmente ao final. **Direção aceita para desenvolvimento: revestimento verde nas paredes internas de todo o box**, ampliando a aplicação anteriormente registrada como parede focal (MAT-009). Manter como referência de produto já registrada Portobello Vivant Sauge Mate 7 × 24,4; tom real, amostra, paginação, áreas e quantidades ainda a conferir. Esta decisão se refere às paredes; não altera automaticamente piso ou teto.

Para a imagem realista final já solicitada, prever comparação entre paredes do box todas verdes e somente uma parede verde, com geometria, iluminação e enquadramento equivalentes. A versão de uma parede é alternativa de comparação, não nova escolha vigente. Resultado visual sujeito à avaliação de Elias.

### Paredes fora do box — Algodão Egípcio confirmado, 18/09/2026

Elias especificou “paredes do banheiro na cor algodão egípcio” ao decidir o acabamento fora do box. **Confirmado: cor Algodão Egípcio nas paredes fora do box**, mantendo o verde sálvia nas paredes internas de todo o box conforme decisão anterior. Esta escolha substitui a proposta imediatamente anterior de revestimento bege na parede da bancada/vaso e off-white nas demais; não tratar essa proposta como aprovada.

Marca, código, produto, acabamento superficial e preparação da base ainda a especificar; não inferir fabricante pelo nome da cor. Compatibilizar proteção da região sujeita a respingos junto à bancada. Não implica remoção automática de revestimentos de entrega nem aprovação de pintura sobre cerâmica sem preparação especificada. Teto não definido por esta escolha.

### Teto do banheiro — branco confirmado, 18/09/2026

Elias respondeu “sim” à proposta de teto branco. **Confirmado: teto branco**, compondo com paredes fora do box em Algodão Egípcio e paredes internas do box em verde sálvia. Marca, tonalidade/código de branco, produto e acabamento superficial ainda a especificar. A aprovação de cor não altera altura ou solução de forro.

### Aparência do box confirmada — 18/09/2026

Elias respondeu “sim” à proposta de **box com vidro transparente e perfis pretos finos**, inspirado na referência e preservando visão do revestimento verde e sensação de amplitude. Confirmada a aparência. Tipo/sentido de abertura, altura, espessura e especificação do vidro, ferragens, dimensões, vedação e fixação permanecem a definir conforme espaço e condições reais. Não inferir box até o teto ou fechamento idêntico ao desenho da referência.

### Apoio de produtos no box — prateleira confirmada, 18/09/2026

Elias escolheu “prateleira pois acho pouco provável que seja possível colocar nicho”, em resposta à proposta de prateleira compacta em Branco Itaúnas, a mesma pedra da bancada. **Confirmado: prateleira no box para shampoo/sabonete, em granito Branco Itaúnas conforme proposta aceita; não prever nicho embutido.** A avaliação do usuário sobre pouca probabilidade de nicho não é comprovação técnica de inviabilidade. Posição, quantidade/dimensões, bordas, escoamento e suportes/fixação permanecem a detalhar conforme os produtos e o espaço, preservando circulação, janela e instalações existentes. Não autoriza recortes de parede. Verificar condições de fixação e limites locais de furação.

### Vaso sanitário — substituição e critérios confirmados, 18/09/2026

Elias quer escolher um vaso novo, mais compacto, para transmitir sensação premium e de banheiro maior. Substitui a proposta anterior de avaliar aproveitamento do vaso entregue pela Cury. **Confirmados: intenção de substituição e prioridades de compacidade, aparência refinada e amplitude.** Marca/modelo, orçamento, cor, dimensões e tipo construtivo ainda não aprovados. Pesquisa deve comparar projeção total instalada a partir da parede acabada, largura, conforto, eixo de saída de esgoto e manutenção; não assumir monobloco como sinônimo de compacto nem ganho real de espaço sem conhecer vaso de entrega e ponto existente. Laterais lisas e assento de fechamento suave são propostas do assistente, não escolhas confirmadas.

### Vaso sanitário — custo-benefício, 18/09/2026

Elias quer manter barato/bom custo-benefício e não conhece os valores. **Não informou nem aprovou teto numérico.** Pesquisa sugere faixa inicial de R$ 600–800 para kit econômico e aproximadamente R$ 1.100–1.300 para alternativa com acabamento visual mais elaborado; são propostas, sem frete/instalação, não orçamento aprovado.

Candidato econômico apresentado: Celite Like branco, kit 1647230010300, nominal 61 × 36 × 74 cm segundo fabricante. Página oficial exibe R$ 699,00 e indisponibilidade; listagem Sodimac consultada exibe R$ 628, sujeito a confirmação de produto/CEP. Não prometer economia de espaço em relação à entrega sem comparar vaso existente e eixo do esgoto. Confirmar versão/conteúdo do assento no fornecedor.

Alternativa de comparação estética: Celite Elite branco, kit com assento soft close, anúncio Loja do Pedrão R$ 1.089,90 (valor pesquisado, não compra/estoque/frete confirmados). Não classificar Elite como mais compacto sem conferir seu desenho técnico. Nenhum vaso escolhido nesta etapa.

Fontes:
- https://www.celite.com.br/produtos/kit-bacia-caixa-acoplada-assento-pp-itens-instalacao-CE647231
- https://www.celite.com.br/celite-services/productSheet30/BR/pt/CE1647230010300/
- https://www.sodimac.com.br/sodimac-br/k/kit-vaso-sanitario-elite-branco-celite/
- https://www.lojadopedrao.com.br/kit-bacia-com-caixa-acoplada-elite-branco-com-assento-soft-close-e-itens-de-instalacao---celite-41025/p

### Vaso sanitário — preferência Celite Elite branco, 18/09/2026

Elias informou “elite branco eu gostei mais” após comparar Celite Like e Celite Elite. **Celite Elite branco passa a ser a preferência principal de projeto para o vaso**, no conjunto apresentado com caixa acoplada, assento soft close e itens de instalação. Like deixa de ser a primeira recomendação para o projeto e permanece apenas alternativa econômica. Não interpretar como compra realizada ou aprovação de valor final; teto do vaso não informado. Referência anterior de preço R$ 1.089,90 na Loja do Pedrão, sujeita a confirmação.

Prioridades preservadas: custo-benefício, aparência refinada, conforto e sensação de amplitude. Dimensões e projeção instalada do Elite, código exato do kit, eixo de saída, espaço frontal e compatibilidade com a unidade ainda a verificar antes da compra. Não afirmar que o Elite é menor que o Like ou que o vaso entregue. Não usar as medidas de 61 × 36 × 74 cm do Like para o Elite.

Página do conjunto apresentado: https://www.lojadopedrao.com.br/kit-bacia-com-caixa-acoplada-elite-branco-com-assento-soft-close-e-itens-de-instalacao---celite-41025/p

### Acessórios e ducha higiênica — 18/09/2026

Elias respondeu “sim, e quero ducha higiênica” à proposta de acessórios discretos em preto fosco (papeleira simples, toalheiro de rosto perto da bancada e ganchos para toalhas de banho) e à pergunta sobre ducha ao lado do vaso. Registrar direção aceita dos acessórios em preto fosco e **inclusão confirmada de ducha higiênica junto ao vaso**. Marca/modelo, quantidades, dimensões e posições exatas ainda a definir. Água fria ou quente/fria na ducha ainda não escolhida; não estender automaticamente a aprovação de água quente do lavatório à ducha. Compatibilizar ponto, registro, pressão e acesso com vaso Elite, gabinete e circulação antes da instalação.

### Ducha higiênica — água quente e fria confirmadas, 18/09/2026

Elias respondeu “água quente também” à escolha de alimentação da ducha higiênica. **Confirmado: ducha higiênica com água quente e fria**, em preto fosco conforme direção dos acessórios. Selecionar conjunto com mistura de temperatura e registro apropriados; modelo, posição e solução de instalação ainda a definir. Não tratar como ducha simples apenas fria. Compatibilizar percurso de água quente, pressão e funcionamento do aquecedor, incluindo vazão de acionamento, antes da execução. Infraestrutura de água quente junto ao vaso ainda não comprovada; aprovação do requisito não comprova ponto existente nem autoriza solução executiva específica. Água quente na pia permanece confirmada.

### Piso confirmado e visualização iniciada — 18/09/2026

Elias confirmou manter o piso claro Travertino Reale Greige, inclusive no box, com acabamento adequado à área molhada. Mantêm-se os registros MAT-007 (Satin fora) e MAT-008 (EXT dentro), sujeitos à ficha e adequação técnica antes de compra. Iniciada visualização realista autorizada ao final das escolhas visuais principais. P01 coloca box à esquerda e lavatório à direita quando vistos da parede de entrada; referência estética é invertida. Render deve respeitar essa disposição e o banheiro nominal 2,09 × 1,24 m. Altura de teto, janela, dimensões de móveis e ferragens não estão executivamente definidas; imagens são estudos, não comprovação de encaixe. Comparar versão principal com todas as paredes internas verdes e alternativa de uma parede verde.

### Revisão após imagens — decisões de Elias, 18/09/2026

Elias escolheu **apenas uma parede verde no box**, citando impacto na iluminação. Substitui a decisão anterior de todas as paredes internas verdes. Usar versão comparativa apresentada: parede do fundo/chuveiro verde; parede da janela clara. Revestimento exato da parede clara ainda a especificar, mantendo aparência clara do estudo.

Correções expressas: **espelho precisa de iluminação para maquiagem**, com proposta de luz frontal difusa nas laterais para iluminar o rosto; luz indireta sob armário não substitui essa função. **Torneira da pia atrás da cuba, entre cuba e espelho, centralizada em relação à cuba**, sem instalação lateral. Compatibilizar alcance do jato, acesso da alavanca, profundidade da bancada e armário raso; imagem não libera furação. Preparar imagem revisada com essas correções; manter demais escolhas.

### Referência visual escolhida e primeiro encaixe — 18/09/2026

Elias pediu salvar R01 como referência visual do banheiro e avançar às medidas para verificar cabimento. Imagem copiada para 03_Referencias/Banheiro_referencia_aprovada_2026-09-18.png e vinculada no índice. Essa aprovação estética não confirma medidas, furação ou reprodução exata de produtos.

Criado Banheiro/Medidas_e_encaixe_2026-09-18.md e esquema proporcional Encaixe_R00.svg. Fonte oficial do Elite branco 1747230010300 confirma 66 × 36 × 81 cm: é 5 cm mais longo que Like, não menor. Em profundidade nominal 124 cm restam 58 cm à frente antes de afastamentos adicionais. Cenário de estudo, sem aprovação: box80 + faixa vaso69 + bancada60 = 209 cm; bancada60 ×45, cuba40 ×30, 15 cm restantes entre faixas frontal e traseira, armário espelhado12–15 cm externos. Porta hipotética70 deixa9 cm até bancada45; folha real desconhecida. Enchimento existente no box precisa ser medido: reserva hipotética30 reduz profundidade livre124 para94. Não remover esse volume para fazer caber nem usar render como prova. Resultado: cabimento preliminar condicionado, pendentes giro real da porta, abertura do box, esgoto, ficha Arion e instalações. Nenhuma mudança de produto ou dimensão executiva aprovada.

### Alternativa compacta ao Elite — pesquisa de 18/09/2026

Elias pediu vaso de estilo semelhante e menor, para ampliar circulação frontal. Candidato recomendado: **Celite VIP branco, kit 1977230012300**, com caixa acoplada e assento PP de queda amortecida. Ficha oficial consultada indica **59 × 37,5 × 80 cm** (comprimento × largura × altura), paredes lisas e sistema Rimless. Há anúncios com58/58,5 cm; neste estudo prevalecem59 cm do fabricante. Comparado com Elite66 ×36, encurta7 cm e alarga1,5 cm. Na profundidade124 cm, sobra nominal frontal passa58 para65 cm, sob mesma hipótese de encosto/instalação. Ganho real condicionado a eixo de esgoto, folga traseira e desenho de instalação; conforto do assento compacto deve ser conferido.

Modelo apenas apresentado, **não substitui automaticamente o Elite escolhido**. Página Mundial aberta mostra R$1.249 e esgotado, embora busca indexada apresentasse R$1.208,70. Não afirmar oferta disponível por esse preço. Fonte oficial: https://www.celite.com.br/celite-services/productSheet30/BR/pt/CE1977230012300/

### Vaso Celite VIP branco aprovado — 18/09/2026

Elias respondeu “perfeito, aprovado” à recomendação do **Celite VIP branco, kit 1977230012300** com caixa acoplada e assento PP de queda amortecida. **Substitui o Celite Elite na escolha vigente.** Dimensões nominais de ficha: comprimento59 × largura37,5 × altura80 cm. Em124 cm de profundidade, frente nominal65 cm, ganho7 cm sobre Elite66. Largura aumenta1,5 cm; na faixa hipotética69, folgas laterais simétricas15,75 cm. Ganho final depende de eixo/afastamento de instalação. Atualizados estudo e esquema Encaixe_R01.svg; demais medidas seguem hipóteses. Preço pesquisado R$992,14 na Ferreira Gonçalves, sem frete/estoque/CEP confirmados; compra não realizada. Imagem salva permanece referência estética, com vaso representado de modo aproximado.

### Conferência bancada, Arion e porta — 18/09/2026

Realizada conferência preliminar autorizada por Elias. Ver Banheiro/Conferencia_bancada_porta_2026-09-18.md. Bancada60 ×45 continua hipótese: cuba40 ×30 deixa10 cm laterais e15 cm somados atrás/à frente, ensaiados como10 +5. Falta desenho da Arion73131B para validar base, alcance, alavanca, fixação e limpeza; armário raso também precisa liberar torneira e abertura das portas. Porta real desconhecida: modelo ideal com folhas70/75/80 deixa9/4/−1 cm até bancada45. Não aumentar profundidade sem compatibilizar porta. Nenhuma dimensão executiva nova aprovada; vaso VIP permanece escolhido.

### Porta do banheiro — informação indisponível, 18/09/2026

Elias não dispõe de medidas além dos documentos da construtora. Revisão da planta P01 e memorial oficial não localizou largura da folha da porta do banheiro. Registrar como pendência de vistoria/quadro de esquadrias, sem reiterar pedido da medida ao usuário. Bancada60 ×45 permanece estudo, não medida liberada para fabricação.

### Água quente aparente sob prateleira — estudo solicitado em 18/09/2026

Elias propôs ocultar uma tubulação externa sob extensão de pedra, inspirada na foto enviada, para alimentar pia e ducha higiênica sem quebrar paredes. Fonte quente imaginada na região do chuveiro, com menção a mangueira; não validar derivação pela mangueira/saída final, que normalmente fica após os controles do banho. Estudar origem quente independente, acessível e permitida. Memorial pp.14/17 confirma restrição a alterações de pontos e previsão quente apenas para chuveiros; rede aparente não é autorização automática. Prateleira sobre caixa precisa de altura própria: tampo76,5 cm é inferior ao VIP80 cm; preservar acesso à tampa e descarga, sem elevar automaticamente a cuba. E21 demanda3,9 L/min para acionar: testar funcionamento da ducha em baixa vazão e espera pela água quente. Referência copiada para03_Referencias/Banheiro_prateleira_ocultacao_tubulacao_2026-09-18.png. Estudo: Banheiro/Agua_quente_aparente_estudo_2026-09-18.md. Conceito em avaliação, sem dimensões executivas ou intervenção autorizada.

### Esclarecimento do percurso quente — 18/09/2026

Elias pretende puxar água quente pela área de enchimento, que informa ser de gesso. Tratar como hipótese de derivação em área técnica, não como decisão de alimentar pela mangueira do chuveiro. Acesso a fechamento não estrutural é distinto de corte em alvenaria estrutural; derivação ainda altera instalação. Memorial não detalha esse caso nem traz exceção explícita. Estudo segue plausível condicionado ao ramal quente privativo acessível, percurso e requisitos técnicos/permissão aplicáveis; sem conclusão de proibição definitiva ou autorização automática. Detalhamento em Banheiro/Agua_quente_aparente_estudo_2026-09-18.md.

### Comparação de percursos de água quente — 18/09/2026

Elias pediu melhores soluções plausíveis e econômicas de ocultação, propondo tubo no teto coberto por gesso no canto. Considerar origem no enchimento como base de estudo. Pesquisa de fabricantes confirma possibilidade de PEX em instalações aéreas; memorialp.13 prevê forro no banheiro. Recomendação preliminar: aproveitar espaço acima do forro existente, se contínuo e suficiente, com descida externa junto ao espelho/gabinete; alternativa de faixa fechada no teto. Comparadas prateleira elevada de pedra e rota baixa atrás do vaso, esta apenas se couber sem avançar a louça. Nenhuma seleção executiva aprovada. Ver Banheiro/Comparacao_rotas_agua_quente_2026-09-18.md, incluindo custos relativos, referência de preço do tubo e limitações. Foco é o percurso completo, incluindo trecho visível entre espelho e bancada e chegada à ducha higiênica. Não rebaixar automaticamente teto inteiro nem engrossar toda a parede.

### Consolidação de toda a conversa do banheiro — 18/09/2026

A pedido de Elias (“documente tudo que falamos aqui”), criado Banheiro/Decisoes_consolidadas_2026-09-18.md, com escolhas vigentes, modelos/códigos, orçamento, medidas oficiais versus hipóteses, histórico de substituições, discussão do memorial, quatro rotas de água quente, custos relativos e pendências. Criado índice Banheiro/README.md e atualizados acessos no início, índice de estudos, resumo e referências. Imagem original de inspiração preservada em03_Referencias/Banheiro_inspiracao_original_2026-09-18.png; referências aprovada e de prateleira já salvas. Comparador exportado como Banheiro/Comparacao_visual_dos_percursos.html para abrir fora da conversa.

Direção de registros pretos simples aceita em “ok prox” após manter chuveiro Livo previamente escolhido; acabamento Livo para base Docol continua candidato condicionado, sem código definitivo. A ducha higiênica permanece quente/fria, modelo e orçamento pendentes. Não registrar a visualização de uma opção no comparador nem o pedido de documentação como aprovação executiva de percurso. Nenhum produto, medida ou obra nova foi autorizado por esta consolidação; nenhuma compra ou publicação externa realizada.
