...
[Abrir as cinco pranchas atualizadas](Layout_da_lavanderia_R01.pdf)

> **Complemento posterior vigente:** [A04.3 R01](../Equipamentos/LG_VC4_escolha_e_pendencias_R01.md) registra a escolha da LG VC4 com Wi-Fi, pagamento parcelado, tensão pendente e teto atualizado para R$ 10.000. Consultar esse complemento para equipamentos e orçamento; o partido desta A04.2 R01 permanece.
...
| Lava e seca | **LG VC4 branca com Wi-Fi**, 12 kg de lavagem / 7 kg de secagem, escolhida por Elias. | Confirmar tensão, manual da versão correta e instalação; cotação final. |
...
| Orçamento | **R$ 10.000** para geladeira, lava e seca e aquecedor, sem instalação. | Cenário IB6 + VC4 + candidato E15: R$ 10.744,70, excesso de R$ 744,70. |
...
IB6 e LG VC4 com Wi-Fi são as referências escolhidas por Elias. Elias atualizou o teto para R$ 10.000. Não houve compra de equipamentos.
...
### Lava e seca - LG VC4 com Wi-Fi escolhida

- LG VC4 branca com Wi-Fi escolhida. Códigos: CV5012WC4 (127 V) ou CV5012WC4A (220 V).
- Capacidade: 12 kg de lavagem e 7 kg de secagem. Tensão da unidade e dimensões/folgas para instalação pendentes; conferir o manual da VC4, sem aplicar o ensaio da VC5.
...
| LG VC4 - referência parcelada da A04.3 | R$ 4.599 |
| Aquecedor E15 GN candidato - referência parcelada | R$ 2.446,70; seleção e gás pendentes |
| Cenário IB6 + VC4 + candidato E15 | **R$ 10.744,70; R$ 744,70 acima do teto** |
...
1. Confirmar tensão da LG VC4 e consultar o manual da versão correta para definir a instalação.
...
- Na revisão R00 foram conferidos arquivo e metadados, sem nova reprodução integral. As imagens de referência continuam sendo os frames já revisados e mapeados na A01.2. Não se afirma igualdade métrica entre unidades espelhadas.

## Histórico e prioridade documental
...
Atualização documental: teto elevado para R$ 10.000 por Elias e escolha anterior da LG VC4 incorporada. Valores reaproveitados da A04.3; sem nova cotação.
